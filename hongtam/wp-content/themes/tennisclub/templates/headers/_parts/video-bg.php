<?php
	if ($video_bg_show) {
		$youtube = tennisclub_get_custom_option('video_bg_youtube_code');
		$video   = tennisclub_get_custom_option('video_bg_url');
		$overlay = tennisclub_get_custom_option('video_bg_overlay')=='yes';
		if (!empty($youtube)) {
			?>
