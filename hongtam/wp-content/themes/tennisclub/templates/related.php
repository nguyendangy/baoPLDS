...
if ( !function_exists( 'tennisclub_template_related_theme_setup' ) ) {
	add_action( 'tennisclub_action_before_init_theme', 'tennisclub_template_related_theme_setup', 1 );
	function tennisclub_template_related_theme_setup() {
		tennisclub_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'tennisclub'),
		...
		tennisclub_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'tennisclub'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'tennisclub'),
			'w'		 => 370,
			'h'		 => 370
		));
		tennisclub_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'tennisclub'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'tennisclub'),
			'w'		 => 370,
			'h'		 => 370
		));
		tennisclub_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'tennisclub'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'tennisclub'),
			'w'		 => 370,
			'h'		 => 370
		));
...
// Template output
if ( !function_exists( 'tennisclub_template_related_output' ) ) {
	function tennisclub_template_related_output($post_options, $post_data) {
		$show_title = true;	
		...
		?>
		<<?php tennisclub_show_layout($tag); ?> class="post_item post_item_<?php echo esc_attr($style); ?> post_item_<?php echo esc_attr($post_options['number']); ?>">
