...
if ( !function_exists( 'tennisclub_template_single_matches_theme_setup' ) ) {
	add_action( 'tennisclub_action_before_init_theme', 'tennisclub_template_single_matches_theme_setup', 1 );
	function tennisclub_template_single_matches_theme_setup() {
		tennisclub_add_template(array(
			'layout' => 'single-matches',
			'mode'   => 'matches',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single matches', 'tennisclub'),
...
// Template output
if ( !function_exists( 'tennisclub_template_single_matches_output' ) ) {
	function tennisclub_template_single_matches_output($post_options, $post_data) {
		...
		$match_preview =(!empty($post_meta['match_link']) && $post_meta['match_link'] != 'inherit' ? $post_meta['match_link'] : '');	
