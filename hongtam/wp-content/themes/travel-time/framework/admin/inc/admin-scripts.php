...
function travel_time_admin_register($hook) {
	...
	wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
		'clear' => 					esc_attr__('Clear', 'travel-time'),
		'clearAriaLabel' => 		esc_attr__('Clear color', 'travel-time'),
		'defaultLabel' => 			esc_attr__('Color value', 'travel-time'),
		'defaultString' => 			esc_attr__('Default', 'travel-time'),
		'defaultAriaLabel' => 		esc_attr__('Select default color', 'travel-time'),
		'pick' => 					esc_attr__('Select Color', 'travel-time'),
	) ); 
