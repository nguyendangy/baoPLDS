...
travel_time_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-general.php', true);
travel_time_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-post.php', true);
travel_time_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-page.php', true);
travel_time_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-other.php', true);


if (class_exists('Cmsmasters_Projects')) {
	travel_time_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-project.php', true);
}


if (class_exists('Cmsmasters_Profiles')) {
	travel_time_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-profile.php', true);
}


if (CMSMASTERS_DONATIONS) {
	travel_time_locate_template('cmsmasters-donations/admin/cmsmasters-theme-options-campaign.php', true);
	travel_time_locate_template('cmsmasters-donations/admin/cmsmasters-theme-options-donation.php', true);
}


travel_time_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-product.php', true);


if (!function_exists('travel_time_get_custom_all_meta_fields')) {
function travel_time_get_custom_all_meta_fields() {
...
function travel_time_admin_enqueue_scripts($hook) {
	if ( 
		...
		wp_localize_script('cmsmasters_theme_options_js', 'cmsmasters_options', array( 
			...
			'want_remove' => 		esc_html__('Do you really want to remove this item?', 'travel-time'), 
...
function show_cmsmasters_meta_box() {
	...
	$custom_all_meta_fields = travel_time_get_custom_all_meta_fields();
