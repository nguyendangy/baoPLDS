...
travel_time_locate_template(CMSMASTERS_SETTINGS . '/inc/cmsmasters-helper-functions.php', true);
travel_time_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-general.php', true);
travel_time_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-font.php', true);
travel_time_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-color.php', true);
travel_time_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-element.php', true);
travel_time_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-single.php', true);
travel_time_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-demo.php', true);
...
function travel_time_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 	esc_html__('Do you really want to remove this sidebar?', 'travel-time'), 
		'remove_google_web_font' => 		esc_html__('Do you really want to remove this google web font?', 'travel-time'), 
		'find' => 				esc_attr__('Find icons', 'travel-time'), 
		'remove_icon' => 		esc_html__('Do you really want to remove this social icon?', 'travel-time'), 
...
function travel_time_form_field_fn($args = array()) {
			...
			echo '<div class="cmsmasters_admin_block">' . 
				'<select class="select" id="' . $id . '_google_font" name="' . $cmsmasters_option_name . '[' . $id . '_google_font]">';
					...
					if (!empty($cmsmasters_fonts_list['local'])) {
						echo '<optgroup label="' . esc_attr__('Local Fonts', 'travel-time') . '">';
					...
					if (!empty($cmsmasters_fonts_list['web'])) {
						echo '<optgroup label="' . esc_attr__('Google Web Fonts', 'travel-time') . '">';
	...
	case 'google_web_fonts':
		...
		'<div class="google_web_fonts_manager">' . 
				...
				if (isset($options[$id]) && is_array($options[$id])) {
					...
					foreach($options[$id] as $font) {
						...
						echo '<div class="google_web_fonts_manager_item">' . 
							'<input class="all-options" type="text" id="google_web_font_family" placeholder="' . esc_attr__('Font Family (for example: Roboto Slab)', 'travel-time') . '" name="' . $cmsmasters_option_name . '[' . $id . '_-_' . $i . '_family]" value="' . esc_attr($font[1]) . '" />' . 
							'<input class="regular-text" type="text" id="google_web_font_style" placeholder="' . esc_attr__('Font Style (for example: Roboto+Slab:100,300,400,700)', 'travel-time') . '" name="' . $cmsmasters_option_name . '[' . $id . '_-_' . $i . '_style]" value="' . esc_attr($font[0]) . '" />' . 
			...
			'<input class="button" type="button" id="add_google_web_font" value="' . esc_attr__('Add Font', 'travel-time') . '" data-font-family-label="' . esc_attr__('Font Family (for example: Roboto Slab)', 'travel-time') . '" data-font-style-label="' . esc_attr__('Font Style (for example: Roboto+Slab:100,300,400,700)', 'travel-time') . '" data-option-name="' . $cmsmasters_option_name . '[' . $id . '_-_" />' . 
		'</div>';
...
function travel_time_add_global_options() {
	$cmsmasters_option_names = array( 
		...
		array( 
			'cmsmasters_options_' . 'travel-time' . '_font_google', 
			travel_time_options_font_fields('google') 
		), 
		array( 
		...
		if ($cmsmasters_option_name[1] !== '') {
			foreach ($cmsmasters_option_name[1] as $selected_option) {
				if ( 
					...
					$selected_option['id'] !== 'travel-time' . '_google_web_fonts' 
				) {
