...
if (comments_open()) {
			...
			echo '<aside class="comments_nav">';
				...
				if (get_previous_comments_link()) {
					echo '<span class="comments_nav_prev cmsmasters_theme_icon_arrow_left">';
						...
						previous_comments_link(esc_attr__('Older Reviews', 'travel-time'));
				...
				if (get_next_comments_link()) {
					echo '<span class="comments_nav_next cmsmasters_theme_icon_arrow_right">';
						...
						next_comments_link(esc_attr__('Newer Reviews', 'travel-time'));
	...
	comment_form(array( 
		...
		'comment_field' => 		'<p class="comment-form-comment">' . 
									...
									'<textarea name="comment" id="comment" cols="67" rows="2" placeholder="' . esc_attr__('Message', 'travel-time') . '"></textarea>' . 
								'</p>', 
		...
		'id_form' => 				'commentform', 
		'id_submit' => 				'submit', 
		'title_reply' => 			esc_html__('Leave a Review', 'travel-time'), 
		'title_reply_to' => 		esc_html__('Leave your review to', 'travel-time'), 
		'cancel_reply_link' => 		esc_html__('Cancel Review', 'travel-time'), 
		'label_submit' => 			esc_html__('Add Review', 'travel-time') 
	));
}
