...
if( !class_exists( 'LocalNews_Theme_Info' ) ) :
    class LocalNews_Theme_Info {
        ...
        function __construct() {
            ...
            // some actions of offer notice
            if( isset( $_GET['localnews_show_black_friday_offer_dismiss'] ) ) {
                update_option( 'localnews_show_black_friday_offer', 'hide' );
            }
            //Add the theme page
            ...
            add_action( 'admin_notices', array( $this, 'add_special_offer_notice' ) );
        ...
        ?>
            <div class="special-banner">
                <a href="<?php echo esc_url('https://blazethemes.com/theme/local-news-pro/'); ?>" target="_blank" rel="noopener">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/local-news-offer.jpg' ); ?>">
                </a>
            </div>
        ...
        /**
         * Add offer notice in admin.
         * 
         * @since 1.0.10
         */
        function add_special_offer_notice() {
            if( isset( $_GET['page'] ) ) {
                if( $_GET['page'] == 'localnews-info' ) {
                    return;
                }
            ...
            if( get_option( 'localnews_show_black_friday_offer' ) == 'hide' ) return;
            ?>
            <div class="localnews-offer-notice notice is-dismissible">
                <div class="notice-content-wrap">
                    <div class="notice-content">
                        <div class="special-banner">
                            <a href="<?php echo esc_url('https://blazethemes.com/theme/local-news-pro/'); ?>" target="_blank" rel="noopener">
                ...
                <div class="notice-dismiss-button" style="text-align: right;">
                    <a style="color: #ff0000" href="<?php echo esc_attr( '?localnews_show_black_friday_offer_dismiss=1' ); ?>"><?php esc_html_e( 'Dismiss this notice', 'localnews' ); ?></a>
                </div>
            </div>
            <?php
        }
