...
if( !function_exists( 'local_news_customizer_about_theme_panel' ) ) :
    ...
    function local_news_customizer_about_theme_panel( $wp_customize ) {
        ...
        $wp_customize->add_section( LOCAL_NEWS_PREFIX . 'about_section', array(
            'title' => esc_html__( 'About Theme', 'localnews' ),
            'priority'  => 1
        ));
        ...
        $wp_customize->add_control( 
            new Local_News_WP_Info_Box_Control( $wp_customize, 'theme_upgrade_info', array(
                ...
                'description' => esc_html__( 'Our premium plans comes with full featured and highly customizable customizer. With unlimited social icons, unlimited homepage news sections, unlimited advertisement area and advanced control fields with 600+ typography features.', 'localnews' ),
                'section'     => LOCAL_NEWS_PREFIX . 'about_section',
