	...
	cmsmasters_heading : { 
		...
		fields : { 
			...
			border_radius : { 
				...
				descr : 	cmsmasters_shortcodes.heading_field_border_radius_descr + " <br /><span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.border_radius_descr_note_1 + " <br />" + cmsmasters_shortcodes.border_radius_descr_note_2 + " <a href=\"//www.css3generator.in/border-radius.html\" target=\"_blank\">" + cmsmasters_shortcodes.border_radius_descr_note_3 + "</a>. <br />" + cmsmasters_shortcodes.border_radius_descr_note_4 + " <a href=\"//screencast.com/t/krCXdo0NN\" target=\"_blank\">" + cmsmasters_shortcodes.border_radius_descr_note_5 + "</a>. <br />" + cmsmasters_shortcodes.heading_field_border_radius_descr_note + ".</span>", 
				def : 		'', 
				required : 	false 
			}, 
			// Heading Link
	...
	cmsmasters_audios : { 
		...
		fields : { 
			...
			audio : { 
				type : 		'multiple', 
				title : 	cmsmasters_shortcodes.audio, 
				descr : 	cmsmasters_shortcodes.audio_field_audio_descr + " <br /><span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.audio_field_audio_descr_note + ' (' + cmsmasters_shortcodes.more_info + " <a href='//www.w3schools.com/html/html5_audio.asp' target='_blank'>" + cmsmasters_shortcodes.click_here + "</a>)</span>", 
				def : 		'[cmsmasters_audio]' + cmsmasters_shortcodes.media_def + '[/cmsmasters_audio]', 
				required : 	true, 
				width : 	'full' 
			}, 
	...
	cmsmasters_button : { 
		...
		fields : { 
			...
			button_border_radius : { 
				...
				descr : 	cmsmasters_shortcodes.button_field_border_radius_descr + " <br /><span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.border_radius_descr_note_1 + " <br />" + cmsmasters_shortcodes.border_radius_descr_note_2 + " <a href=\"//www.css3generator.in/border-radius.html\" target=\"_blank\">" + cmsmasters_shortcodes.border_radius_descr_note_3 + "</a>. <br />" + cmsmasters_shortcodes.border_radius_descr_note_4 + " <a href=\"//screencast.com/t/krCXdo0NN\" target=\"_blank\">" + cmsmasters_shortcodes.border_radius_descr_note_5 + "</a>.</span>", 
				def : 		'', 
				required : 	false 
			}, 
	...
	cmsmasters_embed : { 
		...
		fields : { 
			...
			link : { 
				...
				descr : 	cmsmasters_shortcodes.embed_field_link_descr + "<br /><span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.embed_field_link_descr_note + ' ' + "<a href='//codex.wordpress.org/Embed_Shortcode#Okay.2C_So_What_Sites_Can_I_Embed_From.3F' target='_blank'>" + cmsmasters_shortcodes.embed_field_link_descr_note_link + "</a></span>", 
				def : 		'', 
				required : 	true, 
				width : 	'full' 
			}, 
	...
	cmsmasters_featured_block : { 
		...
		fields : { 
			...
			text_padding : { 
				...
				descr : 	cmsmasters_shortcodes.featured_field_text_padding_descr + ". <br /><span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.featured_field_text_padding_descr_note + ". <br />" + cmsmasters_shortcodes.featured_field_text_padding_descr_note_1 + " <a href=\"//www.w3schools.com/cssref/pr_padding.asp\" target=\"_blank\">" + cmsmasters_shortcodes.featured_field_text_padding_descr_note_2 + "</a>.</span>", 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			}, 
	...
	cmsmasters_videos : { 
		...
		fields : { 
			...
			video : { 
				type : 		'multiple', 
				title : 	cmsmasters_shortcodes.video_title, 
				descr : 	cmsmasters_shortcodes.video_field_video_descr + " <br /><span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.video_field_video_descr_note + ' (' + cmsmasters_shortcodes.more_info + " <a href='//www.w3schools.com/html/html5_video.asp' target='_blank'>" + cmsmasters_shortcodes.click_here + "</a>)</span>", 
				def : 		'[cmsmasters_video]' + cmsmasters_shortcodes.media_def + '[/cmsmasters_video]', 
				required : 	true, 
				width : 	'full' 
			}, 
		...
		fields : { 
			...
			filter_kind : { 
				...
				choises : { 
							...
							'event_and_event_category' :	cmsmasters_shortcodes.timetable_field_filter_kind_choice_event_and_event_category 
				} 
			}, 
			// Filter label
			filter_label : { 
			...
			filter_label_2 : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_filter_label_2_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_filter_label_2_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_filter_label_2_def, 
				required : 	false, 
				width : 	'half', 
			...
			desktop_list_view : { 
				type : 		'checkbox', 
				title : 	cmsmasters_shortcodes.timetable_field_desktop_list_view_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_desktop_list_view_descr, 
				def : 		'', 
				required : 	false, 
				width : 	'half', 
				choises : { 
			...
			event_description_responsive : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_event_description_responsive_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_event_description_responsive_descr, 
				def : 		'none', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'none' : cmsmasters_shortcodes.timetable_field_choice_none, 
							'description-1' : cmsmasters_shortcodes.timetable_field_choice_description_1, 
							'description-2' : cmsmasters_shortcodes.timetable_field_choice_description_2, 
							'description-1-and-description-2' : cmsmasters_shortcodes.timetable_field_choice_description_1_and_description_2 
				} 
			}, 
			// Collapse event hours in responsive mode
			collapse_event_hours_responsive : { 
				type : 		'checkbox', 
				title : 	cmsmasters_shortcodes.timetable_field_collapse_event_hours_responsive_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_collapse_event_hours_responsive_descr, 
				def : 		'', 
				required : 	false, 
				width : 	'half', 
				choises : { 
			...
			colors_responsive_mode : { 
				type : 		'checkbox', 
				title : 	cmsmasters_shortcodes.timetable_field_colors_responsive_mode_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_colors_responsive_mode_descr, 
				def : 		'', 
				required : 	false, 
				width : 	'half', 
				choises : { 
			...
			export_to_pdf_button : { 
				type : 		'checkbox', 
				title : 	cmsmasters_shortcodes.timetable_field_export_to_pdf_button_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_export_to_pdf_button_descr, 
				def : 		'', 
				required : 	false, 
				width : 	'half', 
				choises : { 
			...
			generate_pdf_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_generate_pdf_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_generate_pdf_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_generate_pdf_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			// Show booking button
			show_booking_button : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_show_booking_button_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_show_booking_button_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'no' : 			cmsmasters_shortcodes.timetable_field_show_booking_button_choice_no, 
							'always' : 		cmsmasters_shortcodes.timetable_field_show_booking_button_choice_always, 
							'on_hover' : 	cmsmasters_shortcodes.timetable_field_show_booking_button_choice_on_hover 
				} 
			}, 
			// Show available slots
			show_available_slots : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_show_available_slots_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_show_available_slots_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'no' : 			cmsmasters_shortcodes.timetable_field_show_available_slots_choice_no, 
							'always' : 		cmsmasters_shortcodes.timetable_field_show_available_slots_choice_always 
				} 
			}, 
			// Available Slots Singular
			available_slots_singular_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_available_slots_singular_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_available_slots_singular_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_available_slots_singular_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			...
			available_slots_plural_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_available_slots_plural_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_available_slots_plural_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_available_slots_plural_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			...
			default_booking_view : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_default_booking_view_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_default_booking_view_descr, 
				def : 		'user', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'user' : 	cmsmasters_shortcodes.timetable_field_default_booking_view_choice_user, 
							'guest' : 	cmsmasters_shortcodes.timetable_field_default_booking_view_choice_guest 
				} 
			}, 
			// Allow User Booking
			allow_user_booking : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_allow_user_booking_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_allow_user_booking_descr, 
				def : 		'yes', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_allow_user_booking_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_allow_user_booking_choice_no 
				}, 
			...
			allow_guest_booking : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_allow_guest_booking_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_allow_guest_booking_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_allow_guest_booking_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_allow_guest_booking_choice_no 
				}, 
			...
			show_guest_name_field : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_show_guest_name_field_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_show_guest_name_field_descr, 
				def : 		'yes', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_show_guest_name_field_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_show_guest_name_field_choice_no 
				}, 
			...
			guest_name_field_required : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_guest_name_field_required_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_guest_name_field_required_descr, 
				def : 		'yes', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_guest_name_field_required_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_guest_name_field_required_choice_no 
				}, 
				depend : 	'allow_guest_booking:yes' 
			}, 
			...
			show_guest_phone_field : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_show_guest_phone_field_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_show_guest_phone_field_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_show_guest_phone_field_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_show_guest_phone_field_choice_no 
				}, 
				depend : 	'allow_guest_booking:yes' 
			}, 
			...
			guest_phone_field_required : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_guest_phone_field_required_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_guest_phone_field_required_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_guest_phone_field_required_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_guest_phone_field_required_choice_no 
				}, 
				depend : 	'allow_guest_booking:yes' 
			}, 
			...
			show_guest_message_field : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_show_guest_message_field_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_show_guest_message_field_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_show_guest_message_field_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_show_guest_message_field_choice_no 
				}, 
				depend : 	'allow_guest_booking:yes' 
			}, 
			...
			guest_message_field_required : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_guest_message_field_required_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_guest_message_field_required_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' : 	cmsmasters_shortcodes.timetable_field_guest_message_field_required_choice_yes, 
							'no' : 		cmsmasters_shortcodes.timetable_field_guest_message_field_required_choice_no 
				}, 
				depend : 	'allow_guest_booking:yes' 
			}, 
			// Booking label
			booking_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_booking_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_booking_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_booking_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			// Booked label
			booked_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_booked_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_booked_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_booked_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			// Unavailable label
			unavailable_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_unavailable_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_unavailable_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_unavailable_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			// Popup Booking Label
			booking_popup_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_booking_popup_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_booking_popup_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_booking_popup_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			// Popup Login Label
			login_popup_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_login_popup_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_login_popup_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_login_popup_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			// Popup Cancel Label
			cancel_popup_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_cancel_popup_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_cancel_popup_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_cancel_popup_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			...
			continue_popup_label : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_continue_popup_label_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_continue_popup_label_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_continue_popup_label_def, 
				required : 	false, 
				width : 	'half' 
			}, 
			...
			terms_checkbox : { 
				type : 		'select', 
				title : 	cmsmasters_shortcodes.timetable_field_terms_checkbox_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_terms_checkbox_descr, 
				def : 		'no', 
				required : 	false, 
				width : 	'half', 
				choises : { 
							'yes' :		cmsmasters_shortcodes.timetable_field_terms_checkbox_choice_yes, 
							'no' :		cmsmasters_shortcodes.timetable_field_terms_checkbox_choice_no 
				} 
			}, 
			// Terms And Conditions Message
			terms_message : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.timetable_field_terms_message_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_terms_message_descr, 
				def : 		cmsmasters_shortcodes.timetable_field_terms_message_def, 
				required : 	false, 
				width : 	'half', 
			...
			booking_popup_message : { 
				...
				title : 	cmsmasters_shortcodes.timetable_field_booking_popup_message_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_booking_popup_message_descr + ' {event_title} {column_title} {event_start} {event_end} {event_description_1} {event_description_2} {user_name} {user_email} {tt_btn_book} {tt_btn_cancel} {tt_btn_continue}', 
				def : 		encodeURI('<h2>You are about to book event</h2><div class="event_details_wrapper"><p class="event_details bold">{event_title}</p><p class="event_details">{column_title}</p><p class="event_details">{event_start} - {event_end}</p></div>{booking_form}<p>An initial receipt will be sent out automatically unless you decide not to do so below.</p><div class="tt_btn_wrapper">{tt_btn_book}{tt_btn_cancel}</div>'), 
				required : 	false, 
				width : 	'full' 
			}, 
			...
			booking_popup_thank_you_message : { 
				type : 		'uri_encode_editor', 
				title : 	cmsmasters_shortcodes.timetable_field_booking_popup_thank_you_message_title, 
				descr : 	cmsmasters_shortcodes.timetable_field_booking_popup_message_descr + ' {event_title} {column_title} {event_start} {event_end} {event_description_1} {event_description_2} {user_name} {user_email} {tt_btn_book} {tt_btn_cancel} {tt_btn_continue}', 
				def : 		encodeURI('<h2>Thank you for choosing our services!</h2><div class="event_details_wrapper"><p class="event_details bold">{event_title}</p><p class="event_details">{column_title}</p><p class="event_details">{event_start} - {event_end}</p></div><p class="info">This is a confirmation of your booking. Your booking is now complete and a confirmation email has been sent to you.</p><div class="tt_btn_wrapper">{tt_btn_continue}</div>'), 
				required : 	false, 
				width : 	'full' 
			}, 
			...
			booking_text_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_booking_text_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			booking_bg_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_booking_bg_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			booking_hover_text_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_booking_hover_text_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			booking_hover_bg_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_booking_hover_bg_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			booked_text_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_booked_text_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			booked_bg_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_booked_bg_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			unavailable_text_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_unavailable_text_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			unavailable_bg_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_unavailable_bg_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
			...
			available_slots_color : { 
				type : 		'rgba', 
				title : 	cmsmasters_shortcodes.timetable_field_available_slots_color_title, 
				descr : 	'', 
				def : 		'', 
				required : 	false, 
				width : 	'half' 
