...
(function(g,d,b){tdcRecycle={_maxItems:100,_currentIndex:0,_items:[],$_restoreItem:b,$_restoreContent:b,$_undo:b,$_redo:b,_isInitialized:!1,item:function(b,a,c){this.timestamp=b;this.description=a;this.shortcode=c},init:function(){tdcRecycle._isInitialized||(tdcRecycle.$_restoreItem=g("#tdc-restore"),tdcRecycle.$_restoreContent=g("#tdc-restore-content"),tdcRecycle.$_undo=g(".tdc-restore-undo"),tdcRecycle.$_redo=g(".tdc-restore-redo"),tdcRecycle.$_restoreItem.on("click",function(b){tdcRecycle.$_restoreContent.toggle()}),
tdcRecycle.$_restoreContent.on("click",".tdc-snapshot",function(e){e=g(this);var a=new tdcJobManager.job,c=g(this).find(".tdc-snapshot-shortcode").html();tdcRecycle.$_restoreContent.find(".tdc-snapshot-active").removeClass("tdc-snapshot-active");e.addClass("tdc-snapshot-active");a.shortcode=c;a.columns=3;a.success_callback=function(a){var e=g(tdcAdminIFrameUI._$liveIframe).contents(),l=e.find("#tdc-rows");d.has(a,"replyHtml")&&l.replaceWith(a.replyHtml);window.addWrappers(e);tdcIFrameData._isInitialized=
!1;tdcIFrameData._postOriginalContentJSON=b;window.tdcPostSettings.postContent=c;tdcIFrameData.init(e);tdcOperationUI.init(e);d.has(a,"replyJsForEval")&&tdcAdminIFrameUI.evalInIframe(a.replyJsForEval)};a.error_callback=function(a,c){tdcDebug.log(c);tdcDebug.log(a)};a.is_snapshot=!0;tdcJobManager.addJob(a);tdcSidebarPanel.clearPanel()}),tdcRecycle.$_undo.on("click",tdcRecycle._undo),tdcRecycle.$_redo.on("click",tdcRecycle._redo),tdcRecycle.takeSnapshot(),document.body.addEventListener("keydown",tdcRecycle._checkKeyDown,
!0),document.getElementById("tdc-live-iframe").contentDocument.addEventListener("keydown",tdcRecycle._checkKeyDown,!0),tdcRecycle._isInitialized=!0)},_undo:function(b){1!==tdcRecycle._items.length&&(tdcRecycle._currentIndex++,tdcRecycle._currentIndex>=tdcRecycle._items.length-1&&(tdcRecycle._currentIndex=tdcRecycle._items.length-1,tdcRecycle.$_undo.removeClass("tdc-restore-active")),b=tdcRecycle.$_restoreContent.find(".tdc-snapshot:eq("+tdcRecycle._currentIndex+")"),b.length&&(console.log(tdcRecycle._currentIndex),
b.trigger("click")),1<tdcRecycle._items.length&&tdcRecycle.$_redo.addClass("tdc-restore-active"))},_redo:function(b){1!==tdcRecycle._items.length&&(tdcRecycle._currentIndex--,0>=tdcRecycle._currentIndex&&(tdcRecycle._currentIndex=0,tdcRecycle.$_redo.removeClass("tdc-restore-active")),b=tdcRecycle.$_restoreContent.find(".tdc-snapshot:eq("+tdcRecycle._currentIndex+")"),b.length&&b.trigger("click"),1<tdcRecycle._items.length&&tdcRecycle.$_undo.addClass("tdc-restore-active"))},_checkKeyDown:function(b){if(90===
b.keyCode&&b.ctrlKey){if(b.shiftKey)return tdcRecycle._redo(),!1;tdcRecycle._undo();return!1}},takeSnapshot:function(e){var a={error:b,getShortcode:""};tdcIFrameData.getShortcodeFromData(a);d.isUndefined(a.error)||tdcDebug.log(a.error);if(!d.isUndefined(a.getShortcode)){var c=tdcRecycle._cloneCurrentItem();if(tdcRecycle._isLastSnapshot(a.getShortcode))tdcRecycle._currentIndex=0;else if(tdcRecycle._currentIndex=0,d.isUndefined(c)||a.getShortcode!==c)c=new Date,d.isUndefined(e)&&(e="Restore point"),
e=new tdcRecycle.item(c.getTime(),e,a.getShortcode),tdcRecycle._maxItems===tdcRecycle._items.length&&(tdcRecycle._items.splice(tdcRecycle._items.length-1,1),tdcRecycle.$_restoreContent.find(".tdc-snapshot:last").remove()),tdcRecycle._items.push(e),tdcRecycle.$_restoreContent.find(".tdc-snapshot-active").removeClass("tdc-snapshot-active"),tdcRecycle.$_restoreContent.prepend('<div class="tdc-snapshot tdc-snapshot-active"><div style="width: 150px; float: left">'+c.toLocaleDateString()+" "+c.toLocaleTimeString()+
'</div><div style="width: 350px; float: left">Before '+e.description+'</div><div class="tdc-snapshot-shortcode" style="display: none">'+e.shortcode+"</div></div>"),1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"))}},_isLastSnapshot:function(b){return 0===tdcRecycle._currentIndex&&tdcRecycle._items.length&&tdcRecycle._items[tdcRecycle._items.length-1].shortcode===b?!0:!1},_cloneCurrentItem:function(){if(0!==tdcRecycle._currentIndex){var b=
tdcRecycle._items.find(function(a,c,b){return c===tdcRecycle._items.length-1-tdcRecycle._currentIndex});if(!d.isUndefined(b)){var a=new Date,c=new tdcRecycle.item(a.getTime(),b.description+" - restored",b.shortcode);tdcRecycle._maxItems===tdcRecycle._items.length&&(tdcRecycle._items.splice(tdcRecycle._items.length-1,1),tdcRecycle.$_restoreContent.find(".tdc-snapshot:last").remove());tdcRecycle._items.push(c);tdcRecycle.$_restoreContent.prepend('<div class="tdc-snapshot"><div style="width: 150px; float: left">'+
a.toLocaleDateString()+" "+a.toLocaleTimeString()+'</div><div style="width: 350px; float: left">Before '+c.description+'</div><div class="tdc-snapshot-shortcode" style="display: none">'+c.shortcode+"</div></div>");1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"));return b.shortcode}}}}})(jQuery,_);var tdcSavePost;
...
b+"&uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce);_.isUndefined(g.is_snapshot)&&tdcRecycle.takeSnapshot()},cache:!1,data:d,dataType:"json",statusCode:{404:function(){console.log("tdcJobManager.addJob - ERROR: 404 not found")},500:function(){console.log("tdcJobManager.addJob - ERROR: 500 server error")}},success:function(b,a,c){null===b?g.error_callback(d,"tdcJobManager.addJob - ERROR: Empty response received from server"):
(!0===tdcJobManager._isJobCallbackReplyValid(g.blockUid,b.jobId)?g.success_callback(b):tdcDebug.log("tdcJobManager.addJob - dropped job :) (probably it's older than the last timestamp)"),tdcDebug.groupEnd())},error:function(b,a,c){g.error_callback(d,"tdcJobManager.addJob - Error callback - textStatus: "+a+" errorThrown: "+c);tdcDebug.groupEnd()}})},_isJobCallbackReplyValid:function(g,d){return"undefined"===typeof tdcJobManager._sentJobs[g]||parseInt(tdcJobManager._sentJobs[g])<parseInt(d)?(tdcJobManager._sentJobs[g]=
d,!0):!1},_generateJobId:function(){var g=tdcJobManager.totalJobsCount;tdcJobManager.totalJobsCount++;return g},_getUniqueID:function(){function g(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return g()+g()+"-"+g()+"-"+g()+"-"+g()+"-"+g()+g()+g()}}})();var tdcAdminWrapperUI;
...
if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(l)||!l.is(":visible")&&c!==tdcAdminWrapperUI.$recycle)){var d=tdcOperationUI.isSidebarElementDragged(),k=tdcOperationUI.isElementDragged(),h=!1,m=!1,n=!1,q=!1,t=!1,v=!1,u=tdcOperationUI.isElementWithRowDragged(),r=tdcOperationUI.getRowStartValues();if(k){var w=a.closest(".tdc-elements");if(!d&&(f=tdcIFrameData._getSourceCol(),b.isUndefined(f)))return}else(h=tdcOperationUI.isInnerColumnDragged())&&(w=a.closest(".tdc-inner-columns"));!h&&(m=tdcOperationUI.isInnerRowDragged(),
n=tdcOperationUI.isTempInnerRowDragged(),m||n)&&(w=a.closest(".tdc-elements"));m||n||(q=tdcOperationUI.isColumnDragged())&&(w=a.closest(".tdc-columns"));!q&&(t=tdcOperationUI.isRowDragged(),v=tdcOperationUI.isTempRowDragged(),t||v)&&(w=a.closest("#tdc-rows"));if(d||k||h||m||n||q||t||v){var A="",x=a.find(".td_block_inner");x.length&&(A=x.attr("id"));if(!d&&!b.isUndefined(w)&&w.length){var z=w.children();x=z.index(a);var y=z.index(l);if(c!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(x-y))return;
...
tdcElementUI.bindEmptyElement(c);w.append(c)}tdcRecycle.takeSnapshot("Delete element");tdcOperationUI.setDraggedElement(a);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);tdcIFrameData.changeData({wasSidebarElementDragged:d,wasElementDragged:k,wasInnerColumnDragged:h,wasInnerRowDragged:m,wasTempInnerRowDragged:n,wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,rowStartValues:r,draggedBlockUid:A,sourceColParam:f});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(e);
tdcOperationUI.setCurrentElementOver(e);tb_remove()},e,"Are you sure you want to delete this element?");return}if(-1===y&&1===z.length||2===z.length&&-1!==y){c="";var B=a.closest(".tdc-inner-column");if(B.length)c=" tdc-element-inner-column";else{var C=a.closest(".tdc-column");C.length&&(c=" tdc-element-column")}c=g('<div class="'+tdcOperationUI._emptyElementClass+c+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(c);w.append(c)}}}d&&(c="",k?c="tdc-element":
...
l.remove();tdcIFrameData.changeData({wasSidebarElementDragged:d,wasElementDragged:k,wasInnerColumnDragged:h,wasInnerRowDragged:m,wasTempInnerRowDragged:n,wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,rowStartValues:r,draggedBlockUid:A,sourceColParam:f})}else new tdcNotice.notice("_moveDraggedElement Error: $draggedElement not valid!",!0,!1)}}}})(jQuery,Backbone,_);var tdcRowUI;
...
b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var h=d.outerWidth(!0),m=tdcOperationUI.getCurrentElementOverOffset(),n=0,q=d.prevAll();q.length&&q.each(function(a,c){var b=g(c);b.hasClass("tdc-column")&&(n+=parseInt(b.outerWidth(!0)))});q=d.parent(".tdc-columns").parent(".vc_row");var t=q.css("position");if(b.isUndefined(t)||"static"!==t)if(q=q.css("padding-left"),b.isUndefined(q)||(q=parseInt(q.replace("px",""))),f>m.left+h/2){f=d.next();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(l),
tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+h+q),"margin-left":-24,top:""})}else{f=d.prev();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(l),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+q),"margin-left":-24,top:""})}else if(f>m.left+h/2){f=d.next();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(l),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(m.left+
...
tdcOperationUI.getDraggedElement().closest(".tdc-inner-columns").find(".tdc-inner-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&g(c).trigger(g.Event("fakemouseenterevent",k))});return}d=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var h=d.outerWidth(!0),m=d.offset(),n=0,q=d.prevAll();q.length&&q.each(function(a,c){var b=g(c);b.hasClass("tdc-inner-column")&&(n+=
parseInt(b.outerWidth(!0)))});q=d.parent(".tdc-inner-columns").parent(".vc_row_inner").css("padding-left");q=b.isUndefined(q)?0:parseInt(q.replace("px",""));if(f>m.left+h/2){f=d.next();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(l),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+h+q),"margin-left":-24})}else{f=d.prev();if(!f.length||f.length&&f.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(l),tdcOperationUI.updateInfoHelper();
tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+q),"margin-left":-24})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcInnerColumnUI._elementCssClass}}})(jQuery,Backbone,_);var tdcElementsUI;
...
if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var k=tdcOperationUI.getCurrentElementOverOuterHeight(),h=tdcOperationUI.getCurrentElementOverOuterWidth(),m=tdcOperationUI.getCurrentElementOverOffset(),n=tdcOperationUI.getCurrentElementOverHeight(),q=!1;"inline-block"===d.css("display")&&(q=!0);q?(k=tdcOperationUI.getCurrentElementOverPosition(),q=parseInt(d.css("margin-top")),l.Y>m.top+n/2?(l=tdcElementUI._checkInnerColumnLastElement(l),
...
!0,!1);return}var q=tdcIFrameData.tdcRows;tdcIFrameData.tdcRows=new tdcIFrameData.TdcCollection;b.each(a,function(a,c,b){tdcIFrameData._getData(e,a,k)});b.isEmpty(k)||(tdcDebug.log(k),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",!0,!1));a={error:e,shortcode:e};tdcIFrameData.checkCurrentData(a);b.isUndefined(a.error)||(tdcDebug.log(a.error),new tdcNotice.notice(k,!0,!1));if(h.length!==tdcIFrameData.tdcRows.length){new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}n.$el.find(".tdc-row").each(function(a,c){var e=g(c);e.insertBefore(n.$el);var d=tdcIFrameData.tdcRows.at(a);new tdcIFrameData.TdcLiveView({model:d,el:c});var f=n.$el.prevAll().length,l=d.get("childCollection");q.add(d,{at:f});window.addRowWrappers(e);if(!0===tdcIFrameData._initNewContentStructureData(1,m,d)&&!b.isUndefined(l))if(f={},tdcIFrameData.bindViewsModelsWrappers(f,l,e,1),b.isEmpty(f))e.data("model_id",d.cid);else{for(var k in f)tdcDebug.log(f[k]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1)}});tdcIFrameData.tdcRows.reset();tdcIFrameData.tdcRows=q;n.$el.remove();tdcIFrameData.removeModel(n.model);tdcRowUI.init(f);tdcColumnUI.init(f);tdcInnerRowUI.init(f);tdcInnerColumnUI.init(f);tdcElementUI.init(f);tdcSidebar.setSettings({$currentRow:f},e,this.model)}}else if(this.$el.hasClass("tdc-row-temp"))if(a.has("templateContent")){d=window.atob(a.get("templateContent"));f=this.$el.find(".tdc-row");c=a.get("childCollection");console.log("childCollection");console.log(c);a.set("type","closed");
...
this.model.cid);window.addInnerColumnWrappers(this.$el);m=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(4,m,this.model)&&!b.isUndefined(c)&&(k={},tdcIFrameData.bindViewsModelsWrappers(k,c,this.$el,4),!b.isEmpty(k))){for(h in k)tdcDebug.log(k[h]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerColumnUI.init(this.$el.parent());tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),
...
f.unwrap();this.$el=f;this.$el.data("model_id",this.model.cid);this.model.set("blockUid",f.data("td-block-uid"));f=e;this.model.has("rebindToPanel")&&!0===this.model.get("rebindToPanel")&&(this.model.set("rebindToPanel",!1,{silent:!0}),f=!0);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el),$currentInnerColumn:tdcOperationUI.inInnerColumn(this.$el),$currentElement:this.$el},f,this.model);
var t=this;g.each(h,function(a,c){0===c.indexOf("tdc-element")&&t.$el.addClass(c)});tdcElementUI.bindElement(this.$el)}tdcRecycle.takeSnapshot()}}}))},_getPostOriginalContentJSON:function(){if(b.isUndefined(tdcIFrameData._postOriginalContentJSON)&&!b.isUndefined(window.tdcPostSettings)){var a=Object.keys(window.tdcAdminSettings.mappedShortcodes);a=a.filter(function(a){return 0>["vc_row","vc_column","vc_row_inner","vc_column_inner"].indexOf(a)});a={0:["vc_row"],1:["vc_column"],2:["vc_row_inner"],3:["vc_column_inner"],
4:a};tdcIFrameData._shortcodeParserSettingsClone=a;tdcShortcodeParser.init(a);tdcIFrameData._postOriginalContentJSON=tdcShortcodeParser.parse(0,window.tdcPostSettings.postContent)}return tdcIFrameData._postOriginalContentJSON},_getContentJSON:function(a,c){var e;b.isUndefined(window.tdcPostSettings)||(e=tdcShortcodeParser.parse(a,c));return e},_initStructuredData:function(){if(!tdcIFrameData._isInitialized){var a=tdcIFrameData._getPostOriginalContentJSON();tdcDebug.log(a);if(a.length){tdcIFrameData.tdcRows=
new tdcIFrameData.TdcCollection;var c={};b.each(a,function(a,b,d){tdcIFrameData._getData(e,a,c)});b.isEmpty(c)||(tdcDebug.log(c),new tdcNotice.notice("Errors happened during _initStructureData() -> _getData()!",!0,!1));a={error:e,shortcode:e};tdcIFrameData.checkCurrentData(a);b.isUndefined(a.error)||(tdcDebug.log(a.error),new tdcNotice.notice(c,!0,!1))}return!0}},_initNewContentStructureData:function(a,c,d){c=tdcIFrameData._getContentJSON(a,c);if(c.length){var f={};b.each(c,function(c,b,e){tdcIFrameData._getData(d,
c,f,a)});b.isEmpty(f)||(tdcDebug.log(f),new tdcNotice.notice(f,!0,!1));c={error:e,shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice("Errors happened during _initNewContentStructureData() -> checkCurrentData()!",!0,!1))}return!0},_getData:function(a,c,d,f){var l;if(b.isUndefined(a))var k=tdcIFrameData.tdcRows;else k=a.get("childCollection"),b.isUndefined(k)&&(k=new tdcIFrameData.TdcCollection,a.set("childCollection",k));for(var h in tdcIFrameData._shortcodeParserSettingsClone)if(!(!b.isUndefined(f)&&
parseInt(f,10)>h||b.isUndefined(c.shortcode))&&b.isObject(c.shortcode)&&b.has(c.shortcode,"tag")&&-1!==b.indexOf(tdcIFrameData._shortcodeParserSettingsClone[h],c.shortcode.tag)){0<parseInt(h,10)&&b.isUndefined(a)&&(l="Not rows as the first elements!");!b.isUndefined(a)&&parseInt(a.get("level"),10)>=parseInt(h,10)&&(l="Elements does not respect the shortcode levels! ParentModel (cid: "+a.cid+" ) level: "+a.get("level")+" - element level : "+h);!b.isUndefined(a)&&1<parseInt(h,10)-parseInt(a.get("level"),
10)&&2!==parseInt(a.get("level"),10)&&4!==parseInt(h,10)&&(l="Elements respect the shortcode levels, but the difference higher than 1 is not allowed here!");b.isUndefined(l)||(d[b.keys(d).length]={element:c,info:l,parentModel:a});4!==parseInt(h,10)||b.isUndefined(c.shortcode.content)||(f=b.clone(c.shortcode.attrs.named),f.content=c.shortcode.content,c.shortcode.attrs.named=f);var m=new tdcIFrameData.TdcModel({content:c.content,attrs:c.shortcode.attrs.named,tag:c.shortcode.tag,type:c.shortcode.type,
level:parseInt(h,10),parentModel:a,bindNewContent:!1});b.has(c,"child")&&0<c.child.length&&(m.set("childCollection",new tdcIFrameData.TdcCollection),b.each(c.child,function(a,c,b){tdcIFrameData._getData(m,a,d,e)}));break}b.isUndefined(m)?d[b.keys(d).length]={element:c,info:"Element not found!",parentModel:a}:b.isUndefined(k)||k.add(m)},getModel:function(a,c){if(tdcIFrameData._isInitialized){var e;b.isUndefined(c)&&(c=tdcIFrameData.tdcRows);b.each(c.models,function(c,d,l){b.isUndefined(e)&&(c.cid===
a?e=c:c.has("childCollection")&&(c=c.get("childCollection"),e=tdcIFrameData.getModel(a,c)))});if(!b.isUndefined(e))return e}},getFirstModelByTag:function(a,c){if(tdcIFrameData._isInitialized){var e;b.isUndefined(c)&&(c=tdcIFrameData.tdcRows);b.each(c.models,function(c,d,l){b.isUndefined(e)&&(c.attributes.tag===a?e=c:c.has("childCollection")&&(c=c.get("childCollection"),e=tdcIFrameData.getFirstModelByTag(a,c)))});if(!b.isUndefined(e))return e}},removeModel:function(a,c,e){(b.isUndefined(c)||!0===c)&&
tdcIFrameData.deleteCallback(a);c=a.get("parentModel");b.isUndefined(e)&&(e={});b.isUndefined(c)?tdcIFrameData.tdcRows.remove(a,e):c.get("childCollection").remove(a,e)},deleteCallback:function(a){var c=a.get("blockUid");a=a.get("childCollection");tdcAdminIFrameUI.getIframeWindow().tdcComposerBlocksApi.deleteItem(c);!b.isUndefined(a)&&a.length&&b.each(a.models,function(a,c,b){tdcIFrameData.deleteCallback(a)})},_checkModelData:function(a,c){if(b.isUndefined(c.error)){var d=a.get("parentModel");if(0!==
a.level||b.isUndefined(d))if(!b.isUndefined(d)&&parseInt(d.get("level"),10)>=parseInt(a.level,10))c.error="Elements does not respect the shortcode levels!";else if(!b.isUndefined(d)&&1<parseInt(a.level,10)-parseInt(d.get("level"),10)&&2!==parseInt(d.get("level"),10)&&4!==parseInt(a.level,10))c.error="Elements respect the shortcode levels, but the difference higher than 1 is not allowed here!";else{!b.isUndefined(c.getShortcode)&&b.isUndefined(c.deepLevel)&&(c.deepLevel=0,c["tempShortcodeDeepLevel"+
c.deepLevel]="");if(!b.isUndefined(c.getShortcode)&&a.has("templateContent")&&""!==a.get("templateContent"))c.template=window.atob(a.get("templateContent"));else if(a.has("childCollection")){b.isUndefined(c.getShortcode)||(c.deepLevel++,c["tempShortcodeDeepLevel"+c.deepLevel]="");var f=a.get("childCollection");b.each(f.models,function(a,b,e){tdcIFrameData._checkModelData(f.get(a.cid),c)});b.isUndefined(c.getShortcode)||c.deepLevel--}if(!b.isUndefined(c.getShortcode)){d=a.get("type");var p=a.get("tag"),
k=a.get("attrs"),h="";if("undefined"!==typeof c.images){var m=b.clone(k);b.map(k,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[p].params,function(a,d){if(e===a.param_name)if("attach_image"===a.type){var f=k[a.param_name],l=tdcJobManager._getUniqueID();b.isUndefined(c.images.ids)?(c.images.ids={},c.images.ids[f]=l):b.isUndefined(c.images.ids[f])?c.images.ids[f]=l:l=c.images.ids[f];m[e]=l}else if("tdc_css"===a.param_name&&""!==k.tdc_css){var h=JSON.parse(window.atob(k.tdc_css));b.map(h,
function(a,e){b.map(h[e],function(a,d){if(0===a.trim().indexOf("url")){var f=tdcJobManager._getUniqueID();b.isUndefined(c.images.urls)?(c.images.urls={},c.images.urls[a]=f):b.isUndefined(c.images.urls[a])?c.images.urls[a]=f:f=c.images.urls[a];h[e][d]=f}})});m.tdc_css=window.btoa(JSON.stringify(h))}})});k=m}else"undefined"!==typeof c.newImages&&(m=b.clone(k),b.map(k,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[p].params,function(a,d){if(e===a.param_name)if("attach_image"===a.type){var f=
k[a.param_name],l=c.newImages.find(function(a){return f===a.uid.substring(8)});"undefined"!==typeof l&&(m[e]=l.attachment_id)}else if("tdc_css"===a.param_name&&""!==k.tdc_css){var h=JSON.parse(window.atob(k.tdc_css));b.map(h,function(a,e){b.map(h[e],function(a,b){var d=c.newImages.find(function(c){return a===c.uid.substring(8)});"undefined"!==typeof d&&(h[e][b]='url("'+d.url+'")')})});m.tdc_css=window.btoa(JSON.stringify(h))}})}),k=m,a.set("attrs",k));if("td_block_text_with_title"===p||"vc_column_text"===
p||"vc_raw_html"===p)if(b.map(k,function(a,c){"content"!==c&&(h+=" "+c+'="'+a+'"')}),b.has(k,"content"))try{var g=window.atob(k.content);h="["+p+h+"]"+g+"[/"+p+"]"}catch(q){h="["+p+h+"]"+b.unescape(k.content)+"[/"+p+"]"}else h="["+p+h+"]";else switch(b.map(k,function(a,c){h+=" "+c+'="'+a+'"'}),d){case "single":h="["+p+h+"]";break;case "closed":g="";b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)])||(g=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+
(parseInt(c.deepLevel)+1)]=e);h="["+p+h+"]"+g+"[/"+p+"]";break;case "template":h=c.template}c["tempShortcodeDeepLevel"+c.deepLevel]+=h;0===c.deepLevel&&(c.getShortcode+=h)}}else c.error="Not rows as the first elements!"}},checkCurrentData:function(a){tdcIFrameData._isInitialized&&b.each(tdcIFrameData.tdcRows.models,function(c,b,e){tdcIFrameData._checkModelData(tdcIFrameData.tdcRows.get(c.cid),a)})},changeData:function(a){if(tdcIFrameData._isInitialized){tdcMain.setContentModified();var c=tdcOperationUI.getDraggedElement(),
d=c.prevAll().length;if(a.wasSidebarElementDragged)if(a.wasElementDragged){var f=tdcIFrameData._getDestinationModel([".tdc-inner-column",".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);var p=tdcIFrameData._getDestinationCol();f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection);var k=f.get("childCollection");var h={},m=c.data("start-values"),g;"undefined"!==typeof m&&(m=JSON.parse(window.atob(m)),
"undefined"!==typeof m&&(b.isArray(m)&&m.length?(h=m[0],1<m.length&&(g=m)):h=m));m=c.data("shortcodeName");m=new tdcIFrameData.TdcModel({content:"",attrs:h,tag:m,type:"single",level:4,parentModel:f});new tdcIFrameData.TdcLiveView({model:m,el:c[0]});b.isUndefined(g)||m.set("presetValues",g);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(m.get("tag")+" : sidebar element added");c.data("model_id",m.cid);k.add(m,{at:d});m.set("parentModel",f);m.getShortcodeRender(p,a.draggedBlockUid,!0)}else a.wasTempInnerRowDragged?
(tdcRecycle.takeSnapshot("Sidebar inner-row added"),f=tdcIFrameData._getDestinationModel([".tdc-column"]),b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1),p=tdcIFrameData._getDestinationCol(),f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection),k=f.get("childCollection"),m=c.data("templateContent"),b.isUndefined(m)?(m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:2,parentModel:f}),
new tdcIFrameData.TdcLiveView({model:m,el:c[0]}),h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:m}),c.data("model_id",m.cid),k.add(m,{at:d}),c=new tdcIFrameData.TdcCollection,c.add(h),m.set("childCollection",c),c=new tdcIFrameData.TdcCollection,h.set("childCollection",c)):(m=new tdcIFrameData.TdcModel({templateContent:m,attrs:{},tag:"vc_row_inner",type:"template",level:2,parentModel:f}),new tdcIFrameData.TdcLiveView({model:m,el:c[0]}),c.data("model_id",
m.cid),k.add(m,{at:d})),m.getShortcodeRender(p,a.draggedBlockUid,!0)):a.wasTempRowDragged&&(tdcRecycle.takeSnapshot("Sidebar row added"),m=c.data("templateContent"),b.isUndefined(m)?(k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),p=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:k}),c.data("model_id",k.cid),tdcIFrameData.tdcRows.add(k,{at:d}),d=new tdcIFrameData.TdcCollection,
d.add(p),k.set("childCollection",d),d=new tdcIFrameData.TdcCollection,p.set("childCollection",d),a.wasElementWithRowDragged&&(h={},f={},m=c.data("start-values"),g=c.data("row-start-values"),"undefined"!==typeof g&&(f=JSON.parse(window.atob(g))),k.set({attrs:f}),"undefined"!==typeof m&&(h=JSON.parse(window.atob(m)),b.isArray(h)&&(h=h[0])),m=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",attrs:h,tag:m,type:"single",level:2,parentModel:p}),d.add(c),d=new tdcIFrameData.TdcCollection,
c.set("childCollection",d))):(k=new tdcIFrameData.TdcModel({templateContent:m,attrs:{},tag:"vc_row",type:"template",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),c.data("model_id",k.cid),tdcIFrameData.tdcRows.add(k,{at:d}),d=new tdcIFrameData.TdcCollection,k.set("childCollection",d)),k.getShortcodeRender(1,a.draggedBlockUid,!0));else{m=c.data("model_id");if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model id is not in $draggedElement data!",!0,!1);
return}m=tdcIFrameData.getModel(m);if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model not in structure data!",!0,!1);return}if(a.wasElementDragged){tdcDebug.log("case 1");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("element recycled");tdcIFrameData.removeModel(m);tdcRecycle.takeSnapshot(m.get("tag")+" : element recycled");return}tdcRecycle.takeSnapshot(m.get("tag")+" : element moved");g=m.get("parentModel");f=tdcIFrameData._getDestinationModel([".tdc-inner-column",
".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);g.cid===f.cid?(k=g.get("childCollection"),k.remove(m,{silent:!0}),k.add(m,{at:d})):(p=tdcIFrameData._getDestinationCol(),f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection),k=f.get("childCollection"),tdcIFrameData.removeModel(m,!1,{silent:!0}),k.add(m,{at:d}),m.set("parentModel",f),a.sourceColParam!==p&&m.getShortcodeRender(p,a.draggedBlockUid,!0));
tdcRecycle.takeSnapshot(m.get("tag")+" : element moved")}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");tdcIFrameData.removeModel(m);tdcRecycle.takeSnapshot("Inner row recycled");return}tdcRecycle.takeSnapshot("Inner row moved");g=m.get("parentModel");f=tdcIFrameData._getDestinationModel([".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1);if(g.cid===f.cid)k=g.get("childCollection"),k.remove(m,{silent:!0}),k.add(m,{at:d});else{f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection);k=f.get("childCollection");tdcIFrameData.removeModel(m,!0,{silent:!0});k.add(m,{at:d});m.set("parentModel",f);a=g.get("attrs");d=f.get("attrs");if(b.has(a,"width"))switch(a.width){case "1/3":p="13";break;case "2/3":p="23"}if(b.has(d,"width"))switch(d.width){case "1/3":h="13";break;case "2/3":h="23"}b.isUndefined(p)&&(p="11");
b.isUndefined(h)&&(h="11");if(p!==h&&(a=m.get("childCollection"),!b.isUndefined(a))){a=tdcIFrameData.getChildCollectionWidths(a);b.isUndefined(a)&&(a="11");d="11";k=1;switch(h){case "11":switch(a){case "11":d="11";break;case "23_13":d="23_13";break;case "13_23":d="13_23";break;case "12_12":d="13_13_13";break;case "13_13_13":d="13_13_13"}k=3;break;case "13":switch(a){case "11":d="11";break;case "23_13":d="11";break;case "13_23":d="11";break;case "12_12":d="11";break;case "13_13_13":d="11"}break;case "23":switch(a){case "11":d=
"12_12";break;case "23_13":d="12_12";break;case "13_23":d="12_12";break;case "12_12":d="12_12";break;case "13_13_13":d="12_12"}k=2}if(a!==d||p!==h)tdcIFrameData.changeInnerRowModel(m,a,d),m.getShortcodeRender(k,null,!0)}a=tdcOperationUI.inRow(c);d=tdcOperationUI.inColumn(c);c=tdcOperationUI.inInnerRow(c);b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(c)||tdcSidebar.setSettings({$currentRow:a,$currentColumn:d,$currentInnerRow:c},!0)}tdcRecycle.takeSnapshot(m.get("tag")+" : inner row moved")}else if(a.wasInnerColumnDragged||
a.wasColumnDragged)tdcDebug.log("case 3"),g=m.get("parentModel"),k=g.get("childCollection"),k.remove(m,{silent:!0}),k.add(m,{at:d}),a.wasColumnDragged?(a=tdcOperationUI.inRow(c),b.isUndefined(a)||tdcSidebar.setSettings({$currentRow:a}),tdcRecycle.takeSnapshot("Column moved")):a.wasInnerColumnDragged&&(a=tdcOperationUI.inRow(c),d=tdcOperationUI.inColumn(c),c=tdcOperationUI.inInnerRow(c),b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(c)||tdcSidebar.setSettings({$currentRow:a,$currentColumn:d,$currentInnerRow:c}),
tdcRecycle.takeSnapshot("Inner-column moved"));else if(a.wasRowDragged){tdcDebug.log("case 4");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("row recycled");tdcIFrameData.removeModel(m);tdcRecycle.takeSnapshot("Row recycled");tdcDebug.log(tdcIFrameData.tdcRows);tdcIFrameData.tdcRows.length||(k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:k,el:tdcIFrameData.iframeContents.find("#tdc-rows")[0]}),
p=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:k}),tdcIFrameData.tdcRows.add(k,{at:0}),d=new tdcIFrameData.TdcCollection,d.add(p),k.set("childCollection",d),d=new tdcIFrameData.TdcCollection,p.set("childCollection",d),k.getShortcodeRender(1,a.draggedBlockUid,!0));return}tdcIFrameData.tdcRows.remove(m,{silent:!0});tdcIFrameData.tdcRows.add(m,{at:d});tdcRecycle.takeSnapshot("Row moved");tdcDebug.log("newPosition: "+d);tdcDebug.log(c)}}tdcDebug.log(tdcIFrameData.tdcRows)}},
...
e[2].charAt(1)},type:"closed",level:1,parentModel:a}));tdcIFrameData.changeColumnModel(k,c,e[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===e){c=c.split("_");k=d.at(0);h=k.get("attrs");var m=k.get("childCollection"),g=d.at(1),q=g.get("childCollection");b.isUndefined(h)||(h=b.clone(h),delete h.width,k.set("attrs",h));b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,k.set("childCollection",m));!b.isUndefined(q)&&q.length&&b.each(q.models,function(a,c,b){a.set("parentModel",k);m.add(a)});
...
q=g.get("childCollection");3===e.length?d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&(b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,g.set("childCollection",q)),b.each(d.models,function(a,c,b){a.set("parentModel",g);q.add(a)})),tdcIFrameData.removeModel(a));h=b.clone(h);h.width=l;k.set("attrs",h);c[0]!==e[0]&&
...
""!==e&&(e=e.substring(0,e.length-1));if(l<c.length){var g=d.at(l);m=g.get("attrs");var q=b.clone(m);q.width=e;g.set("attrs",q)}else d.add(new tdcIFrameData.TdcModel({content:"",tag:k,attrs:{width:e},type:"closed",level:1,parentModel:a}))}else for(l=0;l<c.length;l++)if(l<h.length){g=d.at(l);m=g.get("attrs");q=b.clone(m);e="";for(m=0;m<h[l].length;m++)e+=h[l].charAt(m)+"/";""!==e&&(e=e.substring(0,e.length-1));q.width=e;g.set("attrs",q);var t=g}else{g=d.at(h.length);a=g.get("childCollection");var v=
...
f,l){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var k="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(k=c===e.length-1?k+a.width:k+(a.width+"_"))});k=k.replace(/\//g,"");"12_12"!==k&&"23_13"!==k&&"13_23"!==k&&"13_13_13"!==k&&(k="");if("11"===c)if("23"===e)if("23_13"===k){var h=d.at(0),p=d.at(1);l=h.get("attrs");f=p.get("attrs");l=b.clone(l);f=b.clone(f);l.width="1/2";f.width="1/2";h.set("attrs",
l);p.set("attrs",f)}else if("13_23"===k)h=d.at(0),p=d.at(1),l=h.get("attrs"),f=p.get("attrs"),l=b.clone(l),f=b.clone(f),l.width="1/2",f.width="1/2",h.set("attrs",l),p.set("attrs",f);else if("13_13_13"===k){h=d.at(0);p=d.at(1);d=d.at(2);l=h.get("attrs");f=p.get("attrs");var g=d.get("attrs");l=b.clone(l);f=b.clone(f);b.clone(g);l.width="1/2";f.width="1/2";h.set("attrs",l);p.set("attrs",f);f=d.get("childCollection");if(!b.isUndefined(f)&&f.length){var m=p.get("childCollection");b.isUndefined(m)&&(m=
new tdcIFrameData.TdcCollection,p.set("childCollection",m));b.each(f.models,function(a,c,b){m.add(a);a.set("parentModel",p)})}tdcIFrameData.removeModel(d)}else{if(d.models.length){h=d.at(0);l=h.get("attrs");l=b.clone(l);var r=h.get("childCollection");delete l.width;h.set("attrs",l);b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,h.set("childCollection",r));var w=0;for(b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",
...
c)if("11"===e)if("12_12"===k)h=d.at(0),p=d.at(1),l=h.get("attrs"),f=p.get("attrs"),l=b.clone(l),f=b.clone(f),l.width="1/3",f.width="1/3",h.set("attrs",l),p.set("attrs",f),f=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(f);else{if(d.models.length)for(h=d.at(0),l=h.get("attrs"),l=b.clone(l),r=h.get("childCollection"),delete l.width,h.set("attrs",l),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,h.set("childCollection",
...
b.each(a.models,function(a,c,b){a.set("parentModel",h);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else"12_12"===k&&d.models.length&&(h=d.at(0),p=d.at(1),l=h.get("attrs"),f=p.get("attrs"),l.width="1/3",f.width="1/3",h.set("attrs",l),p.set("attrs",f),d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===k||"12_12"!==k)&&d.models.length)for(h=d.at(0),l=h.get("attrs"),l=b.clone(l),r=h.get("childCollection"),
...
e&&"13_13_13"!==e)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)"13_13_13"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e?tdcIFrameData.changeFluidStructureModel(a,c,e):("11"===e?(q=d.at(0),t=q.get("attrs"),l=q.get("childCollection"),h=d.at(1),k=h.get("childCollection"),a=d.at(2),d=a.get("childCollection"),b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t)),b.isUndefined(l)&&(l=new tdcIFrameData.TdcCollection,q.set("childCollection",
l)),!b.isUndefined(k)&&k.length&&b.each(k.models,function(a,c,b){a.set("parentModel",q);l.add(a)}),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",q);l.add(a)}),tdcIFrameData.removeModel(h)):(m=e.split("_"),g=m[0].charAt(0)+"/"+m[0].charAt(1),c=m[1].charAt(0)+"/"+m[1].charAt(1),q=d.at(0),t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),k=h.get("childCollection"),a=d.at(2),d=a.get("childCollection"),t=b.clone(t),t.width=g,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",
e),b.isUndefined(k)&&(k=new tdcIFrameData.TdcCollection,h.set("childCollection",k)),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",h);k.add(a)})),tdcIFrameData.removeModel(a));else if("11"===e){q=d.at(0);t=q.get("attrs");var l=q.get("childCollection");h=d.at(1);var k=h.get("childCollection");b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t));b.isUndefined(l)&&(l=new tdcIFrameData.TdcCollection,q.set("childCollection",l));!b.isUndefined(k)&&k.length&&
b.each(k.models,function(a,c,b){a.set("parentModel",q);l.add(a)});tdcIFrameData.removeModel(h)}else m=e.split("_"),g=m[0].charAt(0)+"/"+m[0].charAt(1),c=m[1].charAt(0)+"/"+m[1].charAt(1),q=d.at(0),t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),t=b.clone(t),t.width=g,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",e),3===m.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:m[2].charAt(0)+"/"+m[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var h=new tdcIFrameData.TdcModel({content:"",
tag:"vc_column_inner",type:"closed",level:3,parentModel:a}),m=e.split("_"),g=m[0].charAt(0)+"/"+m[0].charAt(1);c=m[1].charAt(0)+"/"+m[1].charAt(1);var q=d.at(0),t=q.get("attrs");b.isUndefined(t)?q.set("attrs",{width:g}):(t=b.clone(t),t.width=g,q.set("attrs",t));h.set("attrs",{width:c});d.add(h);3===m.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:m[2].charAt(0)+"/"+m[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;
...
""===d||(f=d,e.val(f));a.val(f);c.data("last_value",f);a=a.get(0)}else if("radio"===e.attr("type")){a=e.closest(".tdc-property").find('input[type="range"]');c=e.closest(".tdc-property").find('input[type="text"]');e.closest(".tdc-property").find('input[type="radio"]:checked');f=e.data("last_value");d=e.data("default_value");var p=e.data("unit");e=a.data("min_"+p);var k=a.data("max_"+p);p=a.data("step_"+p);a.get(0).min=e;a.get(0).max=k;a.get(0).step=p;""===f?(c.val(d),a.val(d)):(c.val(f),a.val(f));
...
d=a.find('input[type="radio"]:checked'),f=a.find('input[type="text"]'),p=c.get(0),k="",h=d.data("default_value"),g=tdcIFrameData.getModel(c.data("model_id")),n=c.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[g.attributes.tag],t=g="";var v=[];for(var u=0;u<q.params.length;u++)if(n===q.params[u].param_name){u=q.params[u].tdc_values;for(var r in u)u.hasOwnProperty(r)&&(v.push(u[r].unit),""===g||""===t)&&(g=u[r].value,t=u[r].unit);break}d.length&&(k=d.data("unit_value"));if("range"===
...
tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name))):(c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+n,tdcSidebar.currentViewportSettings.name)),c.data("range_value",g),c.data("range_unit",t),c.val(g),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),k.prop("checked",!0),p.min=r,p.max=d,p.step=q,p.value=g,k.data("last_value",g),f.val(g));
else if(""===v)if(k=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),"undefined"===typeof k)c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+n,tdcSidebar.currentViewportSettings.name)),c.data("range_value",g),c.data("range_unit",t),c.val(g),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),k.prop("checked",!0),p.min=r,p.max=d,p.step=q,p.value=g,k.data("last_value",g),f.val(g),a.addClass("tdc-css-inherited");
else for(u=0;u<q.params.length;u++){if(n===q.params[u].param_name){v=[];f=[];u=q.params[u].tdc_values;for(r in u)u.hasOwnProperty(r)&&v.push(u[r].unit);for(u=0;u<v.length&&!(f=k.split(v[u]),1<f.length);u++);f.length&&(g=f[0],t=v[u],c.data("range_value",g),c.data("range_unit",t),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),k.prop("checked",!0),p.min=r,p.max=d,p.step=q,p.value=g,k.data("last_value",g),a.find('input[type="text"]').val(g));
c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+n,tdcSidebar.currentViewportSettings.name));a.addClass("tdc-css-inherited");break}}else c.val(v),d.data("last_value",v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name))}else if("radio"===e.attr("type")){if("input"===b.type)return;n=d.data("last_value");q=d.data("unit");r=c.data("min_"+q);d=c.data("max_"+q);q=c.data("step_"+q);p.min=r;p.max=d;p.step=
q;""===n?(f.val(h),c.val(h),v=h):(f.val(n),c.val(n),v=n);c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name));a.removeClass("tdc-css-inherited")}k="";a=jQuery(p).parent().find('input[type="radio"]:checked');a.length&&(k=jQuery(a[0]).data("unit_value"));"focusin"===b.type?p.oldValue=p.value+k:(a=jQuery(p),b=a.data("data-to-save"),g=tdcIFrameData.getModel(a.data("model_id")),p.oldValue!==b&&(tdcSidebarController.onUpdate(g,
jQuery(p).data("param_name"),p.oldValue,_.escape(b)),p.oldValue=b))});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var e=b.val();b.is(":checked")||(e="");var a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,e);this.oldValue=e}});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox-responsive input",function(b){if("focusin"===
...
var e=jQuery(this),a=e.closest(".tdc-property-wrap");e=e.next("input").val();b.toggle();a.after(b);a.next().find(".wp-picker-container").find("input.wp-color-picker").tdPaletteColorPicker("open_palette",e)});d.on("mousedown",function(b){var e=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),c=jQuery("#tdc-gradient"),d=jQuery("#tdc-palette"),f=jQuery("#tdc-font-list"),p=jQuery(".tdc-preset-values-list");a.length?a.get(0).contains(b.target)||(a.hide(),e.after(a)):a=tdcSidebar.buildIconSelector();
c.length?c.get(0).contains(b.target)||(c.hide(),e.after(c)):c=tdcSidebar.buildGradient();d.length?d.get(0).contains(b.target)||(d.hide(),e.after(d)):d=tdcSidebar.buildPalette();f.length&&!f.get(0).contains(b.target)&&(f.hide(),e.after(f));!p.length||p.get(0).contains(b.target)||jQuery(".tdc-preset-values").get(0).contains(b.target)?p.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(b.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},100):p.is(":visible")&&(p.hide(),e=jQuery(b.target),jQuery(".tdc-top-buttons").get(0).contains(b.target)||e.hasClass("tdc-top-buttons")||jQuery(".tdc-sidebar-bottom").get(0).contains(b.target)||e.hasClass("tdc-sidebar-bottom")||jQuery(".tdc-current-element-head").get(0).contains(b.target)||e.hasClass("tdc-current-element-head")?jQuery(".tdc-current-element-head").get(0).contains(b.target)||
e.hasClass("tdc-current-element-head")?(tdcSidebar.setSettings({$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0),jQuery(".tdc-current-element-head").trigger(b)):tdcSidebarPanel.clearPanel():setTimeout(function(){tdcSidebar.setSettings({$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
...
f="tdc-three-column";if(_.has(d,"width"))switch(d.width){case "1/3":f="tdc-one-column";break;case "2/3":f="tdc-two-column"}a.addClass("tdc-dropped-wpeditor");a.html('<iframe id="tdc-iframe-wpeditor" class="'+f+'" src="'+window.tdcAdminSettings.pluginUrl+"/includes/wpeditor.php?wp_path="+window.tdcAdminSettings.ABSPATH+'" scrolling="auto" style="width: 100%; height: 100%" data-model_id="'+e+'" data-mapped_parameter_name="'+c+'"></iframe>');b.show();tdcWindowFrame.setWindowFrame(b)});d.on("click","#tdc-wpeditor .tdc-iframe-close-button",
function(b){b.preventDefault();jQuery("#tdc-wpeditor").hide()});d.on("click",".tdc-sidebar-delete-row",tdcRowHandlerUI.deleteHandler);d.on("click",".tdc-sidebar-delete-inner-row",tdcInnerRowHandlerUI.deleteHandler);d.on("click",".tdc-sidebar-clone-row",tdcRowHandlerUI.cloneHandler);d.on("click",".tdc-sidebar-clone-inner-row",tdcInnerRowHandlerUI.cloneHandler);d.on("click",".tdc-sidebar-shortcode-row",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var e={error:g,
getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,e);_.isUndefined(e.getShortcode)||console.log(e.getShortcode)});d.on("click",".tdc-sidebar-save-shortcode",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var e=b.get("tag"),a={error:g,getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,a);_.isUndefined(a.getShortcode)||tdConfirm.modal({caption:"Saving Shortcode",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},
100);return'<label>Shortcode Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",callbackYes:function(){var c=jQuery("#TB_ajaxContent"),b=c.find(".info");c=c.find("input").val().trim();if(""===c)b.html("Please enter a shortcode name");else{if("undefined"===typeof window.tdcAdminSettings.tdcSavings||""===window.tdcAdminSettings.tdcSavings)window.tdcAdminSettings.tdcSavings={};"undefined"===typeof window.tdcAdminSettings.tdcSavings[e]&&(window.tdcAdminSettings.tdcSavings[e]=
[]);for(var d=!1,p=0;p<window.tdcAdminSettings.tdcSavings[e].length;p++)if(window.tdcAdminSettings.tdcSavings[e][p].name===c){d=!0;break}d?b.html('Shortcode name already exists for "'+e+'" ! Choose another one'):(b.html("Saving..."),window.tdcAdminSettings.tdcSavings[e].push({name:c,shortcode:window.btoa(a.getShortcode)}),tdcUtil.updateTdcSavings(window,function(){jQuery("#TB_ajaxContent").find(".info").html("Shortcode has been saved!");setTimeout(function(){tb_remove()},500)}))}}})});d.on("click",
".tdc-sidebar-current-styles-settings",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var e={error:g,getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,e);var a=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){e="";var c={},d={};for(f in b)0===f.indexOf("tds_")&&(c[f]=b[f]);var f=window.tdcAdminSettings.mappedShortcodes[a].params;for(a=0;a<f.length;a++){var p=!1,k=f[a];if(0===k.param_name.indexOf("tds_")){for(var h in c)if(k.param_name===
h){d[h]=c[h];p=!0;break}p||(d[k.param_name]="")}}for(h in c)switch(c=h.split("-"),c.length){case 2:if(!_.has(d,h)){f=c[0];c=!1;for(var m in d)if(f===d[m]&&1===m.split("-").length){c=!0;break}if(!c){var n;for(n in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[n],f)){var q=n;break}_.has(d,q)&&""===d[q]&&window.tdcAdminSettings.globalStyle[q]===f&&(c=!0)}c||delete b[h]}break;case 3:f=c[0];a=c[2];for(n in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[n],
f)){q=n;break}c=!1;for(m in d)if(f===d[m]&&m===q+"-"+a){c=!0;break}c||_.has(d,q+"-"+a)&&""===d[q+"-"+a]&&window.tdcAdminSettings.globalStyle[q]===f&&(c=!0);c||delete b[h]}for(n in b)e+='"'+n+'" => "'+b[n]+'",\n';console.log(e)}});d.on("click",".tdc-sidebar-font-reset",function(b){tdConfirm.modal({caption:"Clear Font Settings",htmlInfoContent:"This will clear all values for this font group settings.",textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();var b=jQuery(this),a=b.data("model_id"),
c=tdcIFrameData.getModel(a),d=c.get("attrs");d=_.clone(d);for(var f="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),p="",k=0;k<f.length;k++){var h=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+f[k]+":first");if(h.length){var g=h.find('[data-model_id="'+a+'"]');g.length&&(g.val(""),g.data("responsive",""),h.removeClass("tdc-css-inherited"),p=h.find(".tdc-inherit"),p.length&&p.hide(),p=g.data("placeholder"),"undefined"!==typeof p&&g.attr("placeholder",
p),p=g.data("param_name"),delete d[p],g=g.attr("name"),tdcSidebarPanel.deleteResponsiveValues(g))}}c.set("attrs",d);tdcSidebarController.onUpdate(c,p,"","")}})});d.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var e=b.data("model_id");e=tdcIFrameData.getModel(e).get("attrs");var a=b.data("param_name").replace("font_settings",""),c="font_family font_size font_line_height font_style font_weight font_transform".split(" "),d={};_.each(e,function(b,e,l){if(0===e.indexOf(a))for(l=0;l<c.length;l++)if(0<
e.indexOf(c[l])){d[c[l]]=b;break}});_.isEmpty(d)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",callbackYes:function(){var a=jQuery("#TB_ajaxContent"),c=a.find(".info");a=a.find("input").val().trim();if(""===a)c.html("Please enter a font name");else{if("undefined"===typeof window.tdcAdminSettings.tdcSavings||
""===window.tdcAdminSettings.tdcSavings)window.tdcAdminSettings.tdcSavings={};"undefined"===typeof window.tdcAdminSettings.tdcSavings.fonts&&(window.tdcAdminSettings.tdcSavings.fonts=[]);-1===_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:a})?(c.html("Saving..."),window.tdcAdminSettings.tdcSavings.fonts.push({name:a,value:window.btoa(JSON.stringify(d))}),tdcUtil.updateTdcSavings(window,function(){jQuery("#TB_ajaxContent").find(".info").html("Font has been saved!");setTimeout(function(){tb_remove()},
500)})):c.html("Font name already exists! Choose another one")}}})});d.on("click",".tdc-sidebar-font-load",function(){var b=jQuery(this),e=b.closest(".tdc-property-wrap"),a=b.data("model_id"),c=b.data("param_name");if(""!==window.tdcAdminSettings.tdcSavings&&"undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts){var d=jQuery("#tdc-font-list");d.length||(d=tdcSidebar.buildFontList(a,c));d.html("");""!==window.tdcAdminSettings.tdcSavings&&"undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts&&
...
1);tdcUtil.updateTdcSavings(this,function(){e.remove()})});d.on("click",".tdc-font-settings",function(){var b=jQuery(this),e=b.data("value");e=JSON.parse(window.atob(e));var a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs"),d=b.data("param_name").replace("font_settings",""),f="font_family font_size font_line_height font_style font_weight font_transform".split(" ");_.each(e,function(a,b,e){-1!==_.indexOf(f,b)&&(c[d+b]=a)});a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)})},
tdcIconWrapHandler:function(d){var b=jQuery(this),e=jQuery("#tdc-icon-selector");e.length||(e=tdcSidebar.buildIconSelector());var a=b.closest(".tdc-property-wrap");d=e.find(".tdc-icon-selector-filter");var c=e.find(".tdc-icon-selector-lib"),l=e.find(".tdc-icon-selector-content");c.val("");d.val("");l.children().each(function(){jQuery(this).show()});e.data("model_id",b.data("model_id"));e.data("param_name",b.data("param_name"));e.show();a.after(e);b=e.data("param_name");e=tdcIFrameData.getModel(e.data("model_id")).get("attrs");
var f="";_.has(e,b)&&(f=e[b].trim());d.focus();l.find("span").each(function(){var a=jQuery(this),b=a.data("font_class");if(f===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=a.prev();a=a.prev(".tdc-font-separator").data("font_id");c.val(a);c.trigger("change")}else a.removeClass("selected")})},tdcIconRemoveHandler:function(d){var b=jQuery(d.currentTarget);d=b.closest(".tdc-property-wrap").find(".tdc-icon-wrap");b.addClass("tdc-hidden-button");d.addClass("tdc-no-icon-selected");
d.html("");b=d.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,d.data("param_name"),"","")},tdcImageWrapHandler:function(d){var b=jQuery(d.currentTarget);b.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(b);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");
window.send_to_editor=function(e){var a=jQuery("img",e).attr("src"),c="",d="",f="";"undefined"===typeof a?(a=jQuery(e).attr("src"),c=jQuery(e).attr("class"),d=jQuery(e).attr("height"),f=jQuery(e).attr("width")):(c=jQuery("img",e).attr("class"),d=jQuery("img",e).attr("height"),f=jQuery("img",e).attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,e,l){"success"===e&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.data("image_height",d),b.data("image_width",f),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,
window.tb_remove(),e="",l=b.data("model_id"),l=tdcIFrameData.getModel(l),b.hasClass("tdc-no-image-selected")||(e=c.image_id.toString()),c=l.get("attrs"),c.media_size_image_height=d,c.media_size_image_width=f,l.set("attrs",c),tdcSidebarController.onUpdate(l,b.data("param_name"),"",e)))}).fail(function(a,c,b){})};return!1},tdcImageRemoveHandler:function(d){var b=jQuery(d.currentTarget);d=b.closest(".tdc-property-wrap").find(".tdc-image-wrap");b.addClass("tdc-hidden-button");d.addClass("tdc-no-image-selected");
jQuery.removeData(d,"image_link");d.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'");b=d.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,d.data("param_name"),"","")},tdcInheritSelectHandler:function(d){d=jQuery(d.currentTarget);var b=d.closest(".tdc-property-wrap"),e=b.find("[data-responsive]"),a=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all");b.hasClass("tdc-property-dropdown-responsive")&&
("undefined"===typeof a?(b.removeClass("tdc-css-inherited"),e.find("option:selected").removeAttr("selected").find("option:first").attr("selected","selected")):(e.val(a),b.addClass("tdc-css-inherited")),b=tdcSidebarPanel.deleteResponsiveValue(e.attr("name"),tdcSidebar.currentViewportSettings.name),a=tdcIFrameData.getModel(e.data("model_id")),e=e.data("param_name"),tdcSidebarController.onUpdate(a,e,"",b));d.hide()},tdcInheritCheckboxHandler:function(d){d=jQuery(d.currentTarget);var b=d.closest(".tdc-property-wrap"),
e=b.find("[data-responsive]"),a=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all");b.hasClass("tdc-property-checkbox-responsive")&&("undefined"===typeof a?(b.removeClass("tdc-css-inherited"),e.removeAttr("checked")):(""===a?e.removeAttr("checked"):e.attr("checked","checked"),b.addClass("tdc-css-inherited")),b=tdcSidebarPanel.deleteResponsiveValue(e.attr("name"),tdcSidebar.currentViewportSettings.name),a=tdcIFrameData.getModel(e.data("model_id")),e=e.data("param_name"),tdcSidebarController.onUpdate(a,
e,"",b));d.hide()},bindPanelToModel:function(d,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==d.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){var e=window.tdcAdminSettings.mappedShortcodes[d.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=d;for(var a=[],c=0;c<e.params.length;c++){var l=tdcSidebarPanel._defaultGroupName;_.isEmpty(e.params[c].group)||(l=e.params[c].group);a.push(l)}a=
_.uniq(a);var f=l="",g=tdcSidebar.getCurrentTabId(),k,h;l+='<div class="tdc-tabs">';var m=h=k="";for(c=0;c<a.length;c++){f=tdcSidebarPanel._fixGroupName(a[c]);var n=tdcUtil.makeSafeForCSS(f);0===c?(k='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>",h='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+"</a>"):_.isUndefined(g)||g!=="td-tab-"+n?m+='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+"</a>":(k=h,m+='<a href="#" data-tab-id="td-tab-'+
n+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>")}f=n=h=c="";switch(tdcSidebar.currentViewportSettings.name){case "all":c="selected";break;case "landscape":h="selected";break;case "portrait":n="selected";break;case "phone":f="selected"}l=l+(k+m)+'</div><div class="tdc-tab-responsive">';l+='<div class="tdc-responsive-buttons">';l+='<div class="tdc-responsive-all '+c+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';"Newspaper"===window.tdcAdminSettings.themeName&&(l+=
'<div class="tdc-responsive-tablet-landscape '+h+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');l+='<div class="tdc-responsive-tablet-portrait '+n+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';l+='<div class="tdc-responsive-phone '+f+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';l+="</div>";l+="</div>";l+='<div class="tdc-tab-content-wrap">';m=h=k="";for(c=0;c<a.length;c++)f=tdcSidebarPanel._fixGroupName(a[c]),
n=tdcUtil.makeSafeForCSS(f),f="tdc-tab-no-design","css"===n&&(f="tdc-tab-design"),0===c?(k='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">',h='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">',n=d.get("tag"),n=window.tdcAdminSettings.mappedShortcodes[n].tdc_start_values,d.unset("presetValues"),_.isUndefined(n)||(n=JSON.parse(window.atob(n)),_.isArray(n)&&1<n.length&&d.set("presetValues",n)),d.has("presetValues")&&(n=d.get("presetValues"),m+=tdcSidebarPanel._addPresetValuesSelector(n,
d))):_.isUndefined(g)||g!=="td-tab-"+n?m+='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">':(k=h,m+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">'),m+=tdcSidebarPanel._bindGroupAndGetHtml(a[c],e,d),n=' data-model_id="'+d.cid+'" ',"vc_row"===d.attributes.tag?(m+='<div class="tdc-sidebar-row-buttons">',m+='<div class="tdc-sidebar-button tdc-sidebar-delete-row" '+n+' title="Delete the current selected Row">Delete Row</div>',m+='<div class="tdc-sidebar-button tdc-sidebar-clone-row" '+
n+' title="Make a copy of the current selected Row. The copy will appear below the current Row">Clone Row</div>',"dev"===window.tdcAdminSettings.deployMode&&(m+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+n+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>'),m+='<div class="tdc-sidebar-button tdc-sidebar-save-shortcode" '+n+' title="Save current row">SAVE ROW</div>',m+="</div>"):"vc_row_inner"===d.attributes.tag?(m+='<div class="tdc-sidebar-row-buttons">',m+=
'<div class="tdc-sidebar-button tdc-sidebar-delete-inner-row" '+n+' title="Delete the current selected Inner Row">Delete Inner Row</div>',m+='<div class="tdc-sidebar-button tdc-sidebar-clone-inner-row" '+n+' title="Make a copy of the current selected Inner Row. The copy will appear below the current Inner Row">Clone Inner Row</div>',m+='<div class="tdc-sidebar-button tdc-sidebar-save-shortcode" '+n+' title="Save current row">SAVE INNER ROW</div>',m+="</div>"):"vc_column"!==d.attributes.tag&&"vc_column_inner"!==
d.attributes.tag&&(m+='<div class="tdc-sidebar-row-buttons">',"dev"===window.tdcAdminSettings.deployMode&&(m+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+n+' title="Get the current styles\' settings">CONSOLE: style presets</div>'),m+='<div class="tdc-sidebar-button tdc-sidebar-save-shortcode" '+n+' title="Save current row">SAVE SHORTCODE</div>',m+="</div>"),m+="</div>";l=l+(k+m)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(l);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");
tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),c=a.find("[data-responsive]"),b=c.attr("name"),e=c.data("responsive");try{var d=window.atob(e);
window.tdcResponsiveValues[b]=JSON.parse(d)}catch(w){e={},a.hasClass("tdc-property-textfield-responsive")?""!==c.val()&&(e.all=c.val()):a.hasClass("tdc-property-dropdown-responsive")?c.find("option:first").val()!==c.val()&&(e.all=c.val()):a.hasClass("tdc-property-checkbox-responsive")?c.is(":checked")&&(e.all=c.val()):a.hasClass("tdc-property-range-responsive")?e.all=c.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(e.all=c.data("range_value")+c.data("range_unit")),window.tdcResponsiveValues[b]=
e}tdcSidebarPanel.setViewportCurrentResponsiveValue(c)}))});jQuery(".tdc-breadcrumbs").show();tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css");(function(){if("vc_row"===d.get("tag")){var a=jQuery("body .tdc-row-col-dropdown select"),c=jQuery("body .tdc-row-stretch-dropdown select"),b=d.get("childCollection");if(!_.isUndefined(b)){b=tdcIFrameData.getChildCollectionWidths(b);_.isUndefined(b)&&(b="11");a.length?a.val(b):(a=jQuery("body .tdc-row-col-dropdown input[value='"+
b+"']"),a.length&&a.attr("checked","checked"));a=d.get("attrs");if(_.has(a,"full_width"))var e=a.full_width;_.isUndefined(e)&&(e="");c.val(e)}}})();(function(){if("vc_row_inner"===d.get("tag")){var a=jQuery("body .tdc-innerRow-col-dropdown select"),c=d.get("childCollection");if(!_.isUndefined(c)){c=tdcIFrameData.getChildCollectionWidths(c);_.isUndefined(c)&&(c="11");var b=d.get("parentModel").get("attrs"),e="";_.has(b,"width")&&(e=b.width.replace("/",""));if(a.length)switch(a.val(c),e){case "":case "11":a.find("option[value=12_12]").addClass("tdc-block-col");
...
b);case "textfield":return tdcSidebarPanel.addTextField(d,b);case "textfield-responsive":return tdcSidebarPanel.addTextFieldResponsive(d,b);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(d,b);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(d,b);case "css_editor":return"";case "tdc_css_editor":return tdcCssEditor.init(),tdcCssEditor.addComposerCssEditor(d,b);case "horizontal_separator":return tdcSidebarPanel.addSeparatorHorizontal(d,b);case "text_separator":return tdcSidebarPanel.addTextSeparatorHorizontal(d,
b);case "font_header":return tdcSidebarPanel.addFontHeader(d,b);case "font_title":return tdcSidebarPanel.addFontTitle(d,b);case "font_reset":return tdcSidebarPanel.addFontReset(d,b);case "font_save":return tdcSidebarPanel.addFontSave(d,b);case "font_load":return tdcSidebarPanel.addFontLoad(d,b);case "font_settings":return tdcSidebarPanel.addFontSettings(d,b);case "clearfix":return tdcSidebarPanel.addClearfix(d,b);case "tdc_hidden_field":return"";default:return d.param_name+" - "+d.type+"<br>"}},_deletePanel:function(){tdcDebug.log("clear _deletePanel ");
tdcSidebarPanel._hook._hooks=[];tdcSidebarPanel._currentBoundModel=g;jQuery(".tdc-breadcrumbs").hide();jQuery(".tdc-inspector .tdc-current-element-head").empty();jQuery(".tdc-inspector .tdc-tabs-wrapper").empty();jQuery(".tdc-inspector-wrap").removeClass("tdc-inspector-active");jQuery(".tdc-empty-sidebar").show();tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible");tdcSidebar.$_currentElementHead.removeClass("tdc-current-element-siblings-button-on");delete window.tdcResponsiveValues;
...
e+=' data-model_id="'+b.cid+'"';"undefined"!==typeof d&&(e+=' data-param_name="'+d.param_name+'"');return e},_fixGroupName:function(d){switch(d){case "Design options":return"Css";case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return d},clearPanel:function(){tdcSidebarPanel._deletePanel()},_addPresetValuesSelector:function(d,b){var e='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div>'+
('<ul class="tdc-preset-values-list" data-model_id="'+b.cid+'">');for(var a=1;a<d.length;a++){var c="";_.isUndefined(d[a].tdc_preset_individual)||(c='data-individual="1"');var l="";_.isUndefined(d[a].tdc_preset_class)||(l=' class="'+d[a].tdc_preset_class+'"');e+="<li "+c+" "+l+' data-values="'+window.btoa(JSON.stringify(d[a]))+'">'+d[a].tdc_preset_name+"</li>"}e+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",
tdcSidebarPanel.callbackPresets);return e},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});jQuery(".tdc-preset-values-list > li").click(function(){var d=jQuery(this),b=d.data("individual"),e=d.parent(".tdc-preset-values-list");d=JSON.parse(window.atob(d.data("values")));var a=tdcIFrameData.getModel(e.data("model_id")),c={};_.isUndefined(b)||(c=_.clone(a.get("attrs")));_.isObject(d)&&(_.map(d,function(b,e){var d=!1;_.map(window.tdcAdminSettings.mappedShortcodes[a.get("tag")].params,
function(a,f){a.param_name===e&&(d=!0,c[e]=b)});if(!d){var f=c.block_template_id;_.isUndefined(f)&&(f=window.tdcAdminSettings.globalBlockTemplate);_.isUndefined(f)||_.map(window.tdcAdminSettings.mappedBlockTemplates[f].params,function(a,f){a.param_name===e&&(d=!0,c[e]=b)})}d||0!==e.indexOf("tds_")||(c[e]=b)}),a.set("attrs",c));tdcSidebarController.onUpdate(a)})},addColorpicker:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+
tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackColorPicker)||tdcSidebarPanel._hook.addAction("panel_rendered",
tdcSidebarPanel.callbackColorPicker);return a},callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-colorpicker-wrap");_.isUndefined(b.val())||""===b.val()||d.attr("style","background: "+b.val())})},addGradient:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div>'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",
tdcSidebarPanel.callbackGradient);return a},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-gradient-wrap");if(!_.isUndefined(b.val())&&""!==b.val())try{var e=JSON.parse(window.atob(b.val()));_.isUndefined(e.css)||d.attr("style",e.css)}catch(a){e=b.val(),_.isUndefined(e)||d.attr("style","background: "+e)}})},addDropDown:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&
""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",l="",f=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&f.length<=parseInt(d.tdc_min_options))return c;for(var g=0;g<f.length;g++){var k=!1,h="",m=f[g],n=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),q=String(d.value[f[g]]);_.isObject(d.value[f[g]])&&(k=!0,q=_.values(d.value[f[g]])[0],m=_.keys(d.value[f[g]])[0]);if(e||a){0===g&&""===n&&(n=q);n===q&&(h=" checked ");n=_.uniqueId();
var t=q;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)t="col_"+t;l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+n+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+h+' value="'+q+'">';e?(h="",k&&(h="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+h+'" for="'+n+'" title="'+m+'"><div class="'+t+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+n+'" title="'+m+'">'+
q+"</label>"}else n===q&&(h=' selected="selected" '),l+="<option "+h+' value="'+q+'">'+m+"</option>"}f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+f+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||a?c+=l:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+l+"</select>");return c+
"</div></div>"},addDropDownResponsive:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",l="",f=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&f.length<=parseInt(d.tdc_min_options))return c;var g=' data-responsive="" ',k=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var h=JSON.parse(window.atob(k));g=' data-responsive="'+k+'" ';"undefined"!==typeof h[tdcSidebar.currentViewportSettings.name]&&
(k=h[tdcSidebar.currentViewportSettings.name])}catch(r){}for(h=0;h<f.length;h++){var m=!1,n="",q=f[h],t=String(d.value[f[h]]);_.isObject(d.value[f[h]])&&(m=!0,t=_.values(d.value[f[h]])[0],q=_.keys(d.value[f[h]])[0]);if(e||a){0===h&&""===k&&(k=t);k===t&&(n=" checked ");var v=_.uniqueId(),u=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+u;l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+
'" '+n+' value="'+t+'">';e?(n="",m&&(n="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+n+'" for="'+v+'" title="'+q+'"><div class="'+u+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+q+'">'+t+"</label>"}else k===t&&(n=' selected="selected" '),l+="<option "+n+' value="'+t+'">'+q+"</option>"}f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+
'">';c+='<div class="tdc-property-title"><span'+f+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';c+='<div class="tdc-property">';e||a?c+=l:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+g+f+">",c=c+l+"</select>");return c+"</div></div>"},addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+
'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+e+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+a+"/>");return c+"</div></div>"},addCheckBoxResponsive:function(d,b){var e="",a=' data-responsive="" ',c=String(tdcSidebarPanel._getParameterCurrentValue(d,
b));try{var l=JSON.parse(window.atob(c));a=' data-responsive="'+c+'" ';"undefined"!==typeof l[tdcSidebar.currentViewportSettings.name]&&(c=l[tdcSidebar.currentViewportSettings.name])}catch(f){}""!==c&&(e=" checked ");l="";_.has(d,"description")&&""!==d.description&&(l=' title="'+d.description+'" ');c='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+l+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';
...
k+" "+h+" "+l+' min="'+q+'" max="'+t+'" step="'+v+'" value="'+m+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+f+"</div>"+('<input type="text" class="tdc_range_value" value="'+m+'"/>');a+="</div>";a+="</div>";return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),l="",f="",g=[],k=' data-responsive="" ',
h="",m="",n="",q="",t="",v="",u="",r;for(r in a)a.hasOwnProperty(r)&&(g.push(a[r].unit),""===m||""===h)&&(q=a[r].unit,m=' data-range_unit="'+q+'" ',n=a[r].value,h=' data-range_value="'+n+'" ',t=a[r].range_min,v=a[r].range_max,u=a[r].range_step);if(""!==c){var w=c;try{var A=JSON.parse(window.atob(c));k=' data-responsive="'+c+'" ';w="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(x){}if(""!==w){c=[];for(A=0;A<g.length&&!(c=w.split(g[A]),
1<c.length);A++);c.length&&(q=g[A],m=' data-range_unit="'+q+'" ',n=c[0],h=' data-range_value="'+n+'" ')}}for(r in a)a.hasOwnProperty(r)&&(g=_.uniqueId(),l+=" data-value_"+r+'="'+a[r].value+'" ',l+=" data-min_"+r+'="'+a[r].range_min+'" ',l+=" data-max_"+r+'="'+a[r].range_max+'" ',l+=" data-step_"+r+'="'+a[r].range_step+'" ',w=a[r].value,c="",a[r].unit===q&&(w=n,t=a[r].range_min,v=a[r].range_max,u=a[r].range_step,c="checked"),f+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+
...
tdcSidebar.$_liveIframeWrapper.hasClass("tdc-live-iframe-wrapper-inline")||tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-full");tdcMain.resetSidebarHidden()});tdcSidebar.$_sidebarMenu.click(function(b){g(this).toggleClass("tdc-window-open");g(".tdc-sidebar-modal").each(function(a,c){var b=g(c),e=b.data("button_class");b.hasClass("tdc-sidebar-modal-menu")?b.toggleClass("tdc-modal-open"):(b.removeClass("tdc-modal-open"),"undefined"!==typeof e&&""!==e&&(b=g("."+e),b.length&&b.removeClass("tdc-window-open")))})});
tdcSidebar.$_sidebarSearch.keyup(function(b){var a=g(this);g(".tdc-sidebar-element").each(function(c,b){var e=g(b);-1===e.find(".tdc-element-id").html().toLowerCase().indexOf(a.val().trim().toLowerCase())?e.hide():e.show()});g(".tdc-sidebar-separator").each(function(a,b){var c=g(b);c.nextUntil(".tdc-sidebar-separator").is(":visible")?c.show():c.hide()})});tdcSidebar.$_sidebar.on("mouseenter",function(){tdcSidebar.mouseOverSidebar=!0}).on("mouseleave",function(){tdcSidebar.mouseOverSidebar=!1});g("body").css("overflow",
"hidden");tdcSidebar._sidebarModal();tdcSidebar._liveInspectorTabs();tdcSidebar.updateSavedShortcodes();tdcSidebarPanel.init()},hideWpeditor:function(){g("#tdc-wpeditor").hide()},_activeBreadcrumbItem:function(){var b=tdcSidebar.getCurrentModel(),a=b.get("tag"),c="<span>"+window.tdcPostSettings.shortcodes[b.get("tag")]+"</span>",l="",f;for(f in window.tdcAdminSettings.mappedShortcodes)if("undefined"!==typeof window.tdcAdminSettings.mappedShortcodes[f].tdc_category&&("Blocks"===window.tdcAdminSettings.mappedShortcodes[f].tdc_category||
"Big Grids"===window.tdcAdminSettings.mappedShortcodes[f].tdc_category)&&window.tdcAdminSettings.mappedShortcodes[f].tdc_category===window.tdcAdminSettings.mappedShortcodes[a].tdc_category){var p="";f===a&&(p="tdc-selected-option");l+='<li class="'+p+'" data-block_type="'+window.tdcAdminSettings.mappedShortcodes[f].base+'"><div class="tdc-element-ico tdc-ico-'+window.tdcAdminSettings.mappedShortcodes[f].base+'"></div><div class="tdc-element-id">'+window.tdcAdminSettings.mappedShortcodes[f].name+"</div></li>"}""!==
l?(l="<ul>"+l+"</ul>",tdcSidebar.$_currentElementHead.addClass("tdc-block-selection")):tdcSidebar.$_currentElementHead.removeClass("tdc-block-selection");switch(a){case "vc_row":tdcSidebar.$_editRow.hide();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();var k=tdcSidebar.$_editRow;break;case "vc_column":tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editColumn;
break;case "vc_row_inner":tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editInnerRow;break;case "vc_column_inner":tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.show();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editInnerColumn;break;default:tdcSidebar.$_editRow.show(),tdcSidebar.$_editColumn.show(),k=tdcSidebar.getCurrentElement(),"vc_column_inner"===b.get("parentModel").get("tag")?
(tdcSidebar.$_editInnerRow.show(),tdcSidebar.$_editInnerColumn.show()):(tdcSidebar.$_editInnerRow.hide(),tdcSidebar.$_editInnerColumn.hide())}tdcSidebar.$_currentElementHead.html(c);tdcSidebar.$_currentElementSiblings.html(l);tdcSidebar.$_sidebar.find(".tdc-responsiveness").addClass(a);tdcSidebar.$_currentElementHead.off().mouseenter(function(a){a.preventDefault();k.trigger(a)}).mouseleave(function(a){a.preventDefault();k.trigger(a)}).mousedown(function(a){""!==l&&(tdcSidebar.$_currentElementSiblings.toggleClass("tdc-current-element-siblings-visible"),
a=g(this),tdcSidebar.$_currentElementSiblings.hasClass("tdc-current-element-siblings-visible")?a.addClass("tdc-current-element-siblings-button-on"):a.removeClass("tdc-current-element-siblings-button-on"))});tdcSidebar.$_currentElementSiblings.find("li").off().click(function(a){a=g(this);var c=a.data("block_type"),e=a.children(".tdc-element-id").html();a.siblings(".tdc-selected-option").removeClass("tdc-selected-option");a.addClass("tdc-selected-option");tdcSidebar.$_currentElementHead.html("<span>"+
e+"</span>");d.isUndefined(c)||(b.set("tag",c),b.set("rebindToPanel",!0),tdcSidebarController.onUpdate(b));tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});tdcSidebar.$_currentElementSiblings.mouseleave(function(a){tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});tdcSidebar.$_inspector.show()},closeModals:function(){g(".tdc-sidebar-modal").each(function(b,a){var c=g(a),e=c.data("button_class");c.removeClass("tdc-modal-open");
...
c)d.isUndefined(tdcSidebar._currentModel)||tdcSidebar._currentModel.set("current",!1),d.isUndefined(e)?(tdcSidebar._setCurrentRow(b),tdcSidebar._setCurrentColumn(b),tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=b):d.has(e,"$currentRow")&&!d.isUndefined(e.$currentRow)?(tdcSidebar._setCurrentRow(e.$currentRow),d.has(e,"$currentColumn")&&!d.isUndefined(e.$currentColumn)?(tdcSidebar._setCurrentColumn(e.$currentColumn),
d.has(e,"$currentInnerRow")&&!d.isUndefined(e.$currentInnerRow)?(tdcSidebar._setCurrentInnerRow(e.$currentInnerRow),d.has(e,"$currentInnerColumn")&&!d.isUndefined(e.$currentInnerColumn)?(tdcSidebar._setCurrentInnerColumn(e.$currentInnerColumn),d.has(e,"$currentElement")&&!d.isUndefined(e.$currentElement)?(tdcSidebar._setCurrentElement(e.$currentElement),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentElement.data("model_id"))):(tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentInnerColumn.data("model_id")))):
(tdcSidebar._setCurrentInnerColumn(b),tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentInnerRow.data("model_id")))):(tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),d.has(e,"$currentElement")&&!d.isUndefined(e.$currentElement)?(tdcSidebar._setCurrentElement(e.$currentElement),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentElement.data("model_id"))):(tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=tdcIFrameData.getModel(e.$currentColumn.data("model_id"))))):
...
!0),tdcSidebarPanel.bindPanelToModel(tdcSidebar._currentModel,a),tdcSidebar._activeBreadcrumbItem(),tdcSidebar.closeModals(),d.isUndefined(l)||l())},buildGradient:function(){tdcSidebar.$_gradient=g(tdcSidebar._gradientOuterHTML).appendTo(tdcSidebar.$_sidebar);tdcSidebar.$_gradient.find("#tdc-gradient-color-picker").tdGradient();return tdcSidebar.$_gradient},buildPalette:function(){tdcSidebar.$_palette=g(tdcSidebar._paletteOuterHTML).appendTo(tdcSidebar.$_sidebar);tdcSidebar.$_palette.find("#tdc-palette-color-picker").tdPalette();
return tdcSidebar.$_palette},buildFontList:function(){tdcSidebar.$_fontList=g(tdcSidebar._fontListOuterHTML).appendTo(tdcSidebar.$_sidebar);tdcSidebar.$_fontList.html("");"undefined"!==typeof modelId&&"undefined"!==typeof mappedParameter&&""!==window.tdcAdminSettings.tdcSavings&&"undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts&&d.map(window.tdcAdminSettings.tdcSavings.fonts,function(b){g('<div class="tdc-font-settings" data-value="'+b.value+'" data-model_id="'+modelId+'" data-param_name="'+
mappedParameter+'">'+b.name+'<span class="tdc-font-delete">X</span></div>').appendTo(tdcSidebar.$_fontList)});return tdcSidebar.$_fontList},buildIconSelector:function(){tdcSidebar.$_iconSelector=g(tdcSidebar._iconSelectorOuterHTML).appendTo(tdcSidebar.$_sidebar);return tdcSidebar.$_iconSelector},updateSavedShortcodes:function(){var b=g(".tdc-sidebar-saved-shortcodes");b.nextAll().remove();if("undefined"!==typeof window.tdcAdminSettings.tdcSavings&&""!==window.tdcAdminSettings.tdcSavings&&d.intersection(d.keys(window.tdcAdminSettings.tdcSavings),
d.keys(window.tdcAdminSettings.mappedShortcodes)).length){b.show();var a;d.each(tdcAdminSettings.tdcSavings,function(c,b,e){if(c.length&&"gradients"!==b&&"fonts"!==b){var f="",l="",g=!1,p=!1;"vc_row"===b?(f="tdc-row-temp",l=' data-shortcode-name="vc_row" ',g=!0):"vc_row_inner"===b?(f="tdc-element-inner-row-temp",l=' data-shortcode-name="vc_row_inner" ',g=!0):(f="tdc-element",l=' data-shortcode-name="'+b+'" ',p=!0);d.isUndefined(window.tdcAdminSettings.mappedShortcodes[b])||(a+='<div class="tdc-sidebar-separator tdc-sidebar-text-separator"><span>'+
window.tdcAdminSettings.mappedShortcodes[b].name+"</span></div>",d.each(c,function(c,e,k){k=e="";g&&(k=c.shortcode,k=window.atob(k),k=' data-template-content="'+window.btoa(k)+'" ');p&&(tdcIFrameData._getPostOriginalContentJSON(),e=tdcIFrameData._getContentJSON(4,window.atob(c.shortcode)),d.isUndefined(e[0].shortcode.content)||(e[0].shortcode.attrs.named.content=e[0].shortcode.content),e=' data-start-values="'+window.btoa(JSON.stringify([e[0].shortcode.attrs.named]))+'" ');a+='<div class="tdc-sidebar-element '+
f+'" '+l+" "+k+" "+e+'><div class="tdc-element-ico tdc-ico-template"></div><div class="tdc-element-id">'+c.name+' - template</div><div class="tdc-element-delete" data-type="'+b+'" data-name="'+c.name+'"></div></div>'}))}});var c=g(a);c.insertAfter(b);c.find(".tdc-element-delete").on("mousedown",function(a){a.preventDefault();a.stopImmediatePropagation()}).on("mouseup",function(a){if(1===a.which){var c=g(this);a=c.data("type");c=c.data("name");if("undefined"!==typeof window.tdcAdminSettings.tdcSavings[a])for(var b=
window.tdcAdminSettings.tdcSavings[a],e=0;e<b.length;e++)if(b[e].name===c.toString()){b.splice(e,1);b.length||delete window.tdcAdminSettings.tdcSavings[a];tdcUtil.updateTdcSavings();break}return!1}});b.nextAll(".tdc-sidebar-element").each(function(a,c){tdcSidebar._bindElement(g(c))})}else b.hide()}};tdcSidebar.init()})(jQuery,_);var tdcSidebarController={};
...
for(c=0;c<a.params.length;c++)if(a.params[c].param_name===b)return a.params[c];if(0===b.indexOf("tds_")){c=b.split("-");var l=e=g;a=g;2>c.length?new tdcNotice.notice('Param "'+b+'" must have up at least one "-" separator',!0,!1):2===c.length?e=c[0]:3===c.length?(e=c[0],a=c[2]):3<c.length&&new tdcNotice.notice('Param "'+b+'" must have up to at most two "-" separator',!0,!1);if(_.isUndefined(l))for(var f in window.tdcAdminSettings.settingsStyle){if(!_.isUndefined(l))break;for(var p in window.tdcAdminSettings.settingsStyle[f])if(p===
e){l=f;break}}_.isUndefined(e)&&(e=window.tdcAdminSettings.globalStyle[l]);f=window.tdcAdminSettings.settingsStyle[l][e];for(c=0;c<f.params.length;c++)if(p=e+"-"+f.params[c].param_name,_.isUndefined(a)||(p+="-"+a),p===b)return d=JSON.parse(JSON.stringify(f.params[c])),d.param_name=e+"-"+d.param_name,_.isUndefined(a)||(d.param_name+="-"+a),d}new tdcNotice.notice("Map value not found for "+d+" "+b,!0,!1);return g},onUpdate:function(d,b,e,a){var c=new tdcSidebarController._updateJob;c.model=d;c.paramName=
...
c=a.val();var f=1;a.hasClass("tdc-css-opacity")&&(f=.01);var p=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:g.isNumeric(c)&&(p=parseFloat(c)+f);break;case 40:g.isNumeric(c)&&(p=parseFloat(c)-f)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),g.isNumeric(c)&&(p=0<b.originalEvent.deltaY?parseFloat(c)-f:parseFloat(c)+f)}d.isNaN(p)||(1>f&&(p=p.toFixed(2)),a.val(p));tdcCssEditor._updateData(a);c=e.data("tdc-for");b={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,
...
a+'"':""}function c(){return k.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function l(a,b){var g=tdcCssEditor._getSettingsProperty(a,b,e()),l="-",h="";k.isInherited&&(l=g,g="");d.isUndefined(p)||"margin-left"!==a&&"margin-right"!==a||(h=p.get("tag"),h="vc_column"===h||"vc_column_inner"===h?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+g+'" class="tdc-css-box-input tdc-css-box-input-'+a+c()+h+'" title="Css '+a+'" placeholder="'+l+
'" '+tdcSidebarPanel._getParamterDataAtts(f,p)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var f=tdcCssEditor._mappedParameter,p=tdcCssEditor._model,k={isInherited:!1};var h='<div class="tdc-responsiveness">'+('<div class="'+tdcSidebarPanel._getParameterClasses(f)+'">');h=h+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+l("margin-top","");h+=l("margin-right","");h+=l("margin-bottom","");h+=l("margin-left","");h=h+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
...
('<select class="tdc-css-border-style" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},
{value:"inherit",display:"Inherit"}],m);h+="</select></div></div>";m=d.uniqueId();var n=tdcCssEditor._getSettingsProperty("border-color","",e()),q="";k.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';h=h+'<div class="tdc-property-title"><span title="Css border-color">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(f,p)+tdcCssEditor._getDataNoValue(n)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+a(q)+' value="'+n+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("border-radius","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';h=h+'<div class="tdc-property-title"><span title="Css border-radius">Border radius</span></div><div class="tdc-property">'+
('<input class="tdc-css-border-radius" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("width","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-small'+c()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size">Width</span></div><div class="tdc-property">'+
('<input class="tdc-css-width" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("shadow-size","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size">Shadow size</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-size" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');h+="</div></div>";m=d.uniqueId();n=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";k.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(f,p)+tdcCssEditor._getDataNoValue(n)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+a(q)+' value="'+n+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h">Shadow offset H</span></div><div class="tdc-property">'+
('<input class="tdc-css-shadow-offset-h" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v">Shadow offset V</span></div><div class="tdc-property">'+('<input class="tdc-css-shadow-offset-v" '+
tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=d.uniqueId();n=tdcCssEditor._getSettingsProperty("background-color","",e());q="";k.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';h=h+'<div class="tdc-property-title"><span title="Css background-color">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(f,p)+tdcCssEditor._getDataNoValue(n)+' id="'+m+'" name="" type="text" '+a(q)+' value="'+n+'"/>');h+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",b,e());h+='<div class="tdc-property-wrap tdc-property-attach_image'+c()+'">';h=h+'<div class="tdc-property-title"><span title="Css background-image">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property">'+
('<div class="tdc-css-bg-image tdc-css-image-wrap " '+tdcSidebarPanel._getParamterDataAtts(f,p)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");h+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';m=tdcCssEditor._getSettingsProperty("background-style",b,e());h+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+c()+'" data-tdc-for="background-style">';h=h+'<div class="tdc-property-title"><span title="Css background-size & background-repeat">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-style" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],m);h+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("background-position",b,e());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="background-position">';h=h+'<div class="tdc-property-title"><span title="Css background-position">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-position" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",
display:"Right Bottom"}],m);h+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("opacity","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';h=h+'<div class="tdc-property-title"><span title="Css background-image opacity">Background opacity</span></div><div class="tdc-property">'+('<input class="tdc-css-opacity" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');
h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=d.uniqueId();n=tdcCssEditor._getSettingsProperty("color-1-overlay","",e());q="";k.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';h=h+'<div class="tdc-property-title"><span title="Css gradient color From">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(f,p)+tdcCssEditor._getDataNoValue(n)+' id="'+m+'" name="" type="text" '+a(q)+' value="'+n+'"/>');h+="</div></div>";m=d.uniqueId();n=tdcCssEditor._getSettingsProperty("color-2-overlay","",e());q="";k.isInherited&&(q=n,n="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';h=h+'<div class="tdc-property-title"><span  title="Css gradient color To">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(f,p)+tdcCssEditor._getDataNoValue(n)+' id="'+m+'" name="" type="text" '+a(q)+' value="'+n+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("gradient-direction","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction">Gradient direction</span></div><div class="tdc-property">'+
('<input class="tdc-css-gradient-direction" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=tdcCssEditor._getSettingsProperty("content-h-align",b,e());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-content-h-align" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],m);h+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("z-index","",e());n="";k.isInherited&&(n=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';
h=h+'<div class="tdc-property-title"><span title="Z-index">Z-index</span></div><div class="tdc-property">'+('<input class="tdc-css-z-index" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="" type="text" '+a(n)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align">Display</span></div><div class="tdc-property">'+
('<select class="tdc-css-display" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],m);h=h+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>'+
('<div class="tdc-clear-css-properties" '+tdcSidebarPanel._getParamterDataAtts(f,p)+' title="Clear all tab css settings">Clear CSS settings</div>');h+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){g(".tdc-inherit").each(function(a,c){var e=g(c),f=e.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||f.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))e.hide();else{var l=f.data("tdc-for");
...
typeof e){if("undefined"!==typeof tdcCssEditor._currentCssSettings[e][a])return tdcSidebar.currentViewportSettings.name!==e&&(c.isInherited=!0,tdcDebug.log(a)),tdcCssEditor._cleanCss(a,tdcCssEditor._currentCssSettings[e][a]);if("all"!==e)return tdcCssEditor._getAvailableViewportSetting("all",a,c)}}},_getSettingsPropertyFromCssSettings:function(b,a){var c;if("undefined"!==typeof tdcCssEditor._currentCssSettings){var e=tdcSidebar.currentViewportSettings.name;if("undefined"!==typeof tdcCssEditor._currentCssSettings[e]&&
"undefined"!==typeof tdcCssEditor._currentCssSettings[e][b])return tdcSidebar.currentViewportSettings.name!==e&&tdcDebug.log(b),tdcCssEditor._cleanCss(b,tdcCssEditor._currentCssSettings[e][b])}"undefined"===typeof c&&"undefined"!==typeof a&&(c=a);return c},_getSettingsProperty:function(b,a,c){var e;"undefined"===typeof c&&(c={isInherited:!1});"undefined"!==typeof tdcCssEditor._currentCssSettings&&(e=tdcCssEditor._getAvailableViewportSetting(tdcSidebar.currentViewportSettings.name,b,c));"undefined"===
typeof e&&"undefined"!==typeof a&&(e=a);return e},_generateDropdownOptions:function(b,a,c){for(var e=[],f,g=!1,k=0,h=0;h<b.length;h++)d.isUndefined(c)||c!==b[h].value||(k=h),f="",d.isUndefined(a)||a!==b[h].value||(f='selected="selected"',g=!0),e.push("<option "+f+' value="'+b[h].value+'">'+b[h].display+"</option>");g||(e[k]='<option selected="selected" value="'+b[k].value+'">'+b[k].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),
e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),g=b.find(".tdc-css-box-input-margin-left").val().trim(),k=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),n=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),t=b.find(".tdc-css-box-input-padding-right").val().trim(),
...
c);""!==e&&(a["margin-right"]=e);""!==f&&(a["margin-bottom"]=f);""!==g&&(a["margin-left"]=g);""!==k&&(a["border-top-width"]=k);""!==h&&(a["border-right-width"]=h);""!==m&&(a["border-bottom-width"]=m);""!==n&&(a["border-left-width"]=n);""!==q&&(a["padding-top"]=q);""!==t&&(a["padding-right"]=t);""!==v&&(a["padding-bottom"]=v);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=
...
e);b.val(e).trigger("change");a.triggerSelection?a.setColor(e,!0):a.setColor(e)},create:function(){var c=b.data("a8cIris"),p=b.closest(".wp-picker-container"),k=g('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(p.find(".wp-picker-holder")),h=k.find(".cs-alpha-slider"),m=k.find(".cs-alpha-text"),n=k.find(".cs-alpha-slider-offset"),q=g('<div class="tdc-gradient-result-wrap"></div>').prependTo(p);
q=g('<div class="tdc-gradient-result"><div class="tdc-gradient-color tdc-gradient-left-color"></div><div class="tdc-gradient-color tdc-gradient-right-color"></div></div>').prependTo(q);g('<div class="tdc-gradient-degree-label">deg.</div><input class="tdc-gradient-degree" placeholder="0">').appendTo(p.find(".wp-picker-input-wrap"));g('<div class="tdc-gradient-result-labels"><div class="tdc-gradient-result-label">Solid color</div><div class="tdc-gradient-result-label tdc-gradient-result-percentage"></div><div class="tdc-gradient-result-label">Gradient</div></div>').prependTo(p);
g('<div class="tdc-gradient-save">Save Gradient</div>').appendTo(p);var t=g('<div class="tdc-gradient-presets">Gradient presets</div>').appendTo(p),v=g('<div class="tdc-gradient-values-wrapper"></div>').appendTo(p);v=g('<div class="tdc-gradient-values"></div>').appendTo(v);if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.gradients&&d.tdcAdminSettings.tdcSavings.gradients.length)for(var u=!1,r=d.tdcAdminSettings.tdcSavings.gradients.length-1;0<=r;r--){var w=d.tdcAdminSettings.tdcSavings.gradients[r];
try{var A=JSON.parse(d.atob(w));"undefined"!==typeof A.css&&(u=!0,g('<div class="tdc-gradient-value" style="'+A.css+'" data-gradient="'+w+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(v))}catch(x){}}u||t.hide();a.$container=p;a.$gradientResult=q;h.slider({slide:function(a,d){var e=parseFloat(d.value/100);c._color._alpha=e;b.tdGradientColorPicker("color",c._color.toString());m.text(1>e?e:"")},create:function(){var d=parseFloat(l.alpha/100);m.text(1>d?d:"");n.css("background-color",
l.value);p.on("click",".wp-picker-clear",function(){c._color._alpha=1;m.text("");h.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});p.on("click",".wp-picker-default",function(){var a=g.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;m.text(1>d?d:"");h.slider("option","value",a.alpha).trigger("slide")});p.on("click",".wp-color-result",function(a){k.toggle()});g("body").on("click.wpcolorpicker",function(){k.hide()});
p.on("change keyup",".tdc-gradient-degree",function(b){b=g(this);a.degree=b.val().trim();a.mixedColors=a._getMixedColors();a._updateGradient();a._saveValue()})},value:l.alpha,step:1,min:0,max:100})}})}else b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},change:function(a,c){b.val(c.color.toString()).trigger("change")}});"undefined"===typeof a.setColor&&(a.setColor=function(b,c){"undefined"===typeof a.currentColor&&(a.currentColor="left",a.$gradientResult.find(".tdc-gradient-selected-color").remove(),
